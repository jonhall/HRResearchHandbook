...
\begin{solution}
Some activities are very prominent in the early stages, like identifying the research problem and reviewing the literature, and minimal later on. In Stage 1, identifying the research problem and reviewing the literature take up 50\% of the time available.

Other activities start or become prominent in later stages, particularly generating and analysing evidence, and interpreting and evaluating findings, which only feature in the last two stages.

Some activities feature throughout the project: this is particularly the case for writing up. The framework assume that 20\% of the time is devoted to this.

Work planning and risk management start early on and are sustained throughout the project.  
\end{solution}\end{question}
%%Hack to correct tcbox behaviour
\color{black}

You should, of course, take this framework guidelines with a pinch of salt, as the precise balance between the stages and their activities in your own project is influenced by many factors, including the topic you have chosen, any previous research experience you may have, your supervisor's advice, requirements established by your course, etc. We will consider more detailed descriptions by stage in the follow-up chapters, including indicative timings, but again, nothing is written in stone.
...
\begin{SimpleNColTable}{t:allStagesActivities}{6}{Percentage of effort per research activity and stage}[lccccc]
...
\begin{itemize}
	...
	\item milestones and deliverables are included at specific points on the timeline using specific symbols, often diamonds
\end{itemize}
\end{solution}\end{question}
%%Hack to correct tcbox behaviour
\color{black}
...
\begin{SimpleNColTable}{t:allStagesActivitiesExample}{11}{Calculating effort per research activity and stage using the framework}[lcccccccccc]
...
Based on the study time set out by your course, calculate the time to allocate to each research activity by stage by making use of the percentages in \Cref{t:allStagesActivities}.
\begin{guidance}
...
\paragraph{Making your spare time productive} There will be much to read throughout your project, so you should always keep something to read with you, which you can look at while waiting for something, say a bus, or in a queue or travelling on public transports. You may be surprised of how much reading you can do while waiting.
...
\item you should carry out the practical activities included in this book to develop your research skills and perform essential research and project tasks.
\end{itemize}
