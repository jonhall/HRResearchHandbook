...
\begin{SimpleNColTable}{t:allStagesActivitiesExample}{11}{Effort per research activity and stage using the framework}[lcccccccccc][row{Z}={bg=\frameColor,fg=white}]
