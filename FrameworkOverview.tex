...
Our framework we give you will allow you to manage these risks to give you the best chance of submitting something that will satisfy the examiners and show your Masters research skills off in their best light.
...
Figure~\ref{pastedgraphic} depicts the relations between activities in the research process: as you can see, these are complex relationships, with much tangling and intertwining. Note also that reflecting, reporting, work planning and risk management apply to both individual activities, and the process overall, which is why in the figure they are separated from the other activities.
...
\item The research problem identifies the phenomena under study, which inform your choice of the research strategy and methods within your research design
...
\item Your work plan inform what you have to do and when
...
The 5 stages are designed to balance the activities you need to carry out in your project; each is allocated a recommended proportion of the overall project time. The exact balance is influenced by many factors, including topic, any previous research experience and your supervisor's advice, so take the next figure with a pinch of salt -- it's only meant to show you how the focus on research activities changes in the stages. We will consider more detailed descriptions by state in the follow-up chapters, including indicative timings, but again, nothing is written in stone.

\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{slug diagram.pdf}
...
\begin{itemize}
\item the research process, its key activities and their relations
\item the aim and structure of our framework and how it can support your Masters research
\item how to map the key stages on the framework onto your project timeline 
\item the critical success factors for Masters research
\end{itemize}
