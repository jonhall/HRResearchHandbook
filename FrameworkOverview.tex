...
\begin{solution}
The figure highlights how the main focus of the project changes over time, but also that many activity are repeated over several stages, reflecting the iterative and incremental nature of the research process.

Some activities are prominent in the early stages, like identifying the research problem and reviewing the literature, and minimal later on. In fact, in Stage 1, identifying the research problem and reviewing the literature take up 50\% of the time available. This shouldn't surprise you as the early stages are mainly concerned with establishing the scope of, and justifying, your research.

Other activities start or become prominent in later stages, particularly generating and analysing evidence, and interpreting and evaluating findings, which only feature in the last two stages. The framework recommend you think deeply about your research design before you start collecting data, to ensure your best chance of generating evidence to address your aim and objectives.

Some activities feature throughout the project: this is particularly the case for writing up. The framework assumes that 20\% of your time is devoted to this.
...
Research activity&{Stage 1\\ (15\%)}&{Stage 2\\ (15\%)}&{Stage 3\\ (15\%)}&{Stage 4\\ (25\%)}&{Stage 5\\ (30\%)}\\
Identifying the research problem &20\% &10\% &5\% &2\% &0\%\\
Reviewing the literature &30\% &30\% &5\% &2\% &0\%\\

Setting your aim and objectives &5\% &5\% &10\% &3\% &0\%\\
...
\begin{itemize}
	...
	\item monitoring your progress against your plan on a regular basis, and make adjustments as needed.
\end{itemize}
...
You can use the framework to establish an approximate duration for each of your project stages. Specifically, Stage 1 will take 15\% of the overall project time, that is 7.5 weeks or 90 hours, Stage 2 and Stage 3 will span the same length, Stage 4 will take 25\% of the overall project time, that is 12.5 weeks or 150 hours, and Stage 5 will take 25\% of the overall project time, that is 15 weeks or 180 hours. The timeline will then span from the project start date to the end of the 50th week after that. Each stage start and end dates can then be arranged along this timeline with each stage following from the previous one: Stage 1 will therefore start at project start while Stage 5 will end at the end of the project.
\end{example}


\begin{question}[subtitle={Activity: Establishing your project timeline}] 
Based on the study time set out by your course, establish the timeline for your project, identifying when each stage starts and ends.
\begin{solution}
...
If you are already familiar with a different project scheduling approach for projects, then feel free to use that instead of a Gantt chart. What matters is that it allows you to organise your project work effectively and communicate it easily to others. In particular, you share and discuss your project plan with your supervisor.
