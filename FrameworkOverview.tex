...
You can use the framework to establish an approximate duration for each of your project stages. Specifically, Stage 1 will take 15\% of the overall project time, that is 7.5 weeks or 90 hours, Stage 2 will span the same length, Stage 3 will take 20\% of the overall project time, that is 10 weeks or 120 hours, etc. The timeline will then span from the project start date to the end of the 50th week after that. Each stage start and end dates can then be arranged along this timeline with each stage following from the previous one: Stage 1 will therefore start at project start while Stage 5 will end at the end of the project.
\end{example}
