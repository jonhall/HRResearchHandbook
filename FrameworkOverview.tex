...
Our framework therefore emphasises reflection and reflexivity essential activities within the research process, to develop and consolidate the knowledge and skills you need to be a competent and confident researchers, and to guard against \gls{bias}.
...
\begin{SimpleNColTable}{t:allStagesActivitiesExample}{11}{Effort per research activity and stage using the framework}[lcccccccccc][row{Z}={bg=\frameColor,fg=white,font=\bfseries}]
