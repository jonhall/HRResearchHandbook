...
\RequirePackage{booktabs}%%For fancy lines in tables:TODO: can be removed when tabularray
\RequirePackage{multicol}%%For multiple columns:TODO: can be removed when tabularray

%%For additional caption options
%%Allows captions in longtables
%%TODO: remove when tabularray
\RequirePackage{caption}
\RequirePackage{float}

%%%For tables – intention is to migrate to tabularray
%%TODO: Move to tabularray
...
%%TODO: remove when tables moved to tabularray
\makeatletter
\def\ltabulary{%
	\def\endfirsthead{\\}%
	\def\endhead{\\}%
...
%%TODO: For tables – intention is to migrate to tabularray
...
%%TODO: Add risk table
%%TODO: collect and add other tables

%%Hack for @{}lllll@{} instead of @{}LLLL@{}
%%TODO: Remove when all tables properly formatted
\newcolumntype{l}{L}
