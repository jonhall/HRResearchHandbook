...
\NewDocumentEnvironment{SimpleTwoColTable}{O{Missing caption}O{X[1]X[4]}+b}
	{\begin{SimpleTable}{\textwidth}{#2}[#1]
	#3	
	\end{SimpleTable}
	}{}
...
\NewDocumentEnvironment{SimpleFiveColTable}{O{Missing caption}O{X[1]X[8]X[8]X[8]X[8]}+b}
	{\begin{SimpleTable}{1.4\textwidth}{#2}[#1]
	#3	
	\end{SimpleTable}
	}{}
...
\NewDocumentEnvironment{SimpleSixColTable}{O{Missing caption}O{X[1]X[8]X[8]X[8]X[8]X[8]}+b}
	{\begin{SimpleTable}{1.4\textwidth}{#2}[#1]
	#3	
	\end{SimpleTable}
	}{}
