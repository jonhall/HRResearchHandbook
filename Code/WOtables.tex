...
\SetChild{idh=WOLineii}		
	Chapter 2: Literature Review&&\Cref{sect:stage1LiteratureReview}\\
		...
		\naitem Critical summary, including knowledge gap to be addressed by the research&\WOnocontent\\
...
\SetChild{idh=WOLinevi}		
	Chapter 6: Evaluation and conclusion&\WOnocontent\\
...
\SetChild{idh=WOLineiv}
	Chapter 4: Research design& Finalise your methodological choices&\Cref{ch:DataGenerationMethods,ch:ModellingMethods,ch:AnalysisMethods}\\
		...
		\newitem Research procedures& Detail your procedures for applying your chosen methods &\Cref{???}\\
...
\SetChild{idh=WOLinev}
	Chapter 5: Analysis and interpretation\\
		...
		\newitem Summary of key findings&Summarise the key findings from your data analysis in this stage&\Cref{???}\\
		\naitem Interpretation in relation to aim and objectives\\
\SetChild{idh=WOLinevi}
	Chapter 6: Evaluation and conclusion&\\
		\naitem Evaluation against aim and objectives\\
...
\NewDocumentEnvironment{SimpleNColTableWG}{
  ...
  \begin{longtblr}[
      ...
      caption = {Stage #1 Writing Guidance},
  ]{
      width   = \widetablewidth,
      colspec = {X[3,l]X[6,l]X[-1,l]},
      cells   = {bg=\WOtableColor},
...
%		\olditem Definitions\\
\SetChild{idh=WOLineii}		
	Chapter 2: Literature Review&{Your literature review should provide a critical account of your in-depth engagement with the academic (and other) relevant literature, including identifying key trends, ideas and knowledge gaps. \\
		Most of your citations should point to academic articles. Both the coverage and the depth of your review matter\\You should ensure your review is well structured, with a logical narrative flow and with arguments well supported by appropriate citations.\\
...
\SetChild{idh=WOLineiii}
	Chapter 3: Research definition&{You should ensure that your research problem is well articulated, your aim consistent with your research problem and broken down into appropriate objectives, and that the intended knowledge contribution is clearly expressed. \\
...
\SetChild{idh=WOLineiv}		
	Chapter 4: Research design&{This chapter should demonstrate your critical engagement with all elements of research design, including a detailed account of the data and evidence on which your research is based, its sources and use, and the research strategy(ies) and methods you have chosen and applied.\\
...
\SetChild{idh=WOLinev}		
	Chapter 5: Analysis and interpretation&{This chapter should provide a detailed account of your data generation and analysis, the findings you have derived and their interpretation in relation to your research aim and objectives.\\
...
\SetChild{idh=WOLineviii}
	Dissertation appendices&{You can use appendices to include supplementary material in support of the main body of your dissertation, for instance sample raw data, questionnaires used in data generation, programme code for software models, and other created artefacts, detailed calculations,~\etc{}.}&\Cref{???}\\
