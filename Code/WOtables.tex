...
%				toggle-left-and-right
				...
				colspec = {X[3]X[6]X[1]|[2pt,\frameColor]},
				cells={#6}, %Cell background colour
%		  		hlines = {fg = \frameColor, wd=2pt}, %column{2} = {co=1}, 
		  		hline{2,3,8,12,15,19,24,28,35,36,38,Z} = {2-3}{fg = \frameColor,2pt},
		  		hline{2,3,8,12,15,19,24,28,35,36,38,Z} = {1}{fg = #6,2pt},
				vline{Z} = {fg = \frameColor, wd=2pt}, %column{2} = {co=1}, 
				vline{2} = {1}{fg = #6, wd=2pt}, %column{2} = {co=1}, 
				colsep = 5pt,
