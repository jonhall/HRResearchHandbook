...
\NewDocumentEnvironment{SimpleNColTableWO}{
		...
		m% 					% caption
		O{X[3]X[6]X[1]|[2pt,\frameColor]}%	% optional colspec
...
%				toggle-left-and-right
				...
				cells	={bg=#6}, %Cell background colour
		  		hline{2,3,8,12,15,19,24,28,35,36,38,Z} = {2-3}{fg = \frameColor,wd=2pt},
		  		hline{2,3,8,12,15,19,24,28,35,36,38,Z} = {1}{fg = #6,wd=2pt},
