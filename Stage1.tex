...
\begin{SimpleNColTable}{stage1ResearchActivities}{4}{\RActivitiesTableCaption{1}}[X[4]X[1]X[8]X[8]]
...
\begin{SimpleNColTable}{tab:exploratoryProblemsB}{2}[\the\textwidth]{Exploratory Problems – Example 2}
	[X[1]X[2]]
Problem element & Description \\
...
Justification J & Software technology changes rapidly, so that software engineers need upskilling and retraining very frequently\\
\end{SimpleNColTable}
...
\begin{SimpleNColTable}{tab:PredictiveProblemsB}{2}[\the\textwidth]{Predictive Problems – Example 2}
	[X[1]X[2]]
Problem element & Description \\
...
\begin{SimpleNColTable}{tab:DesignProblemsB}{2}[\the\textwidth]{Design Problems – Example 2}
	[X[1]X[2]]
Problem element & Description \\
...
\begin{question}[subtitle={Activity: Applying Keshav's approach to Keshav's paper!}] The paper you need to investigate is Keshav's paper itself:
%
\begin{quotation}
	\fullcite{keshav2007read}
\end{quotation}
...
\begin{SimpleNColTable}{tab:keshavBibdata}{2}[\narrowtablewidth]{Summary-comparison matrix entries for \citeauthor{keshav2007read}, \citeyear{keshav2007read}}[{X[1]X[4]}]
\relax\\
...
%\end{itemize}
We conducted a literature search, out of which we identified a number of potentially relevant articles. We constructed a summary-comparison matrix, whose first couple of entries are illustrated in~\Cref{t:exampleSCMatrix}. It is not necessary for you to understand all the details, but you may notice that our entries are quite detailed.

\begin{SimpleNColTable}{t:exampleSCMatrix}{6}[\narrowtablewidth]{Example of summary-comparison matrix entries}[{X[1]X[1]X[1]X[1]X[1]X[1]}]
\relax\\
...
\begin{quotation}
general lack of awareness of how learning analytics tools can provide meaningful and actionable information for everyday use; stakeholder engagement needed throughout tool development	
\end{quotation}
...
\begin{SimpleNColTable}{t:exampleCMatrix}{4}[\narrowtablewidth]{Example of concept matrix entries}[{X[1]X[1]X[1]X[1]X[1]}]
\relax\\
...
\begin{question}[subtitle={Activity: Understanding your university's guidelines on GenAI}] Using your university's intranet\todo{The reader may not have this.} look up any policy or guideline related to the use of generative AI. Write a brief summary of what you have found out which may be relevant to your research project.
\begin{solution} 
...
\item \gloss{observation bias}\footnote{Observation bias is also known as the Hawthorne effect. You can read about the original Hawthorne experiment here: \textbackslash{}url\{\href{https://en.wikipedia.org/wiki/Hawthorne_effect}{https://en.wikipedia.org/wiki/Hawthorne\_effect}\}} is the tendency of participants being observed during a study to change their behaviour, possibly to please the researcher or provide the answers they think the research is seeking. A way to counteract it is to complement your observation with other kinds of data collection and compare the outcomes -- this is called \gloss{triangulation}
...
In the next activity, you will use~\Cref{tab:criteriaForReport} to assess whether your report is of good standard. Even if you are not required to submit a report at this stage of your project, a good report will give you a solid base on which to build and report your next research increment. B and in the long run, will save you time and effort in writing up your dissertation.

\begin{SimpleNColTable}{tab:criteriaForReport}{2}{Criteria for reviewing your report}[X[2]X[6]]
Criteria & Prompts \\
...
\begin{itemize}
\item Stage 1 gives you a solid foundation for your whole research project. This is where you establish the scope of your research and its contribution to knowledge
