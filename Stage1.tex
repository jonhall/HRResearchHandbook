...
\begin{SimpleNColTable}{tab:Annaproblemelements}{2}[\narrowtablewidth]{Elements of Anna's problem}[lR[4]]
...
\begin{SimpleNColTable}{tab:descriptiveProblemsB}{2}[\narrowtablewidth]{Description Problems  – Example 2}[lR[4]]
Problem element & Description \\
...
\begin{SimpleNColTable}{tab:DesignProblemsA}{2}[\the\narrowtablewidth]{Design Problems – Example 1}{\activityColor}
	[lR]
Problem element & Description \\
...
We can take each problem element in turn to identify possible search terms. In doing so, we have come up with this initial set, which should be sufficient to perform our initial search:
...
\begin{SimpleNColTable}{tab:riskTable}{5}[\narrowtablewidth]{Project risk table}[lcccc]
