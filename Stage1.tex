...
For this stage, and the following ones, we provide two really important tables that structure and drive the work by which you will see progress in your research and in the creation of your dissertation. For the research, each stage contains a Research Activity table\footnote{The first such table is~\Cref{stage1ResearchActivities}, and we'll get back to it in a minute or so.} and a Writing Outcome table\footnote{The first of which is~\Cref{stage1WritingOutcomes}.} through which you can understand and track the stage's contribution to your dissertation. The Research Activity table also inlcudes prompts in relation to topics it is important you discuss with your supervisor during the stage, while the Writing Outcomes table includes references to materials in this book which can help you achieve each of them. 
