...
\begin{SimpleTwoColTable}[Elements of Anna's problem\label{tab:Annaproblemelements}]
...
\begin{question}[subtitle={Activity: Anna's initial problem}] Based on the information in~\Cref{tab:claraproblemelements} and using the problem template, write down Clara's initial research problem.
