...
\chapter{Stage 1 Activities and Outcomes}\label{c:outcomes}
...
For this stage, and the following ones, we provide two really important tables that structure and drive the work by which you will see progress in your research and in the creation of your dissertation. For the research, each stage contains a Research Activity table\footnote{The first such table is \Cref{stage1ResearchActivities}, and we'll get back to it in a minute or so.} and a Writing Outcome table\footnote{The first of which is \Cref{stage1WritingOutcomes}.} through which you can understand and track the stage's contribution to your dissertation. The Research Activity table also provides prompts in relation to topics it is important you discuss with your supervisor during the stage, while the Writing Outcome table includes references to materials in this book which can help you achieve each writing outcome. 
...
% summarised in \Cref{tab:stage1}. The table has entries for all but two of the research process activities that were introduced in \Cref{sect:ResearchActivities}\todo{Check xref}. We did say that Stage 1 was intense!
...
Reflection and reflexivity&10\%&At stage end, think critically about experiential learning in relation to the research process and its activities&\\
Planning work&5\%&Refine your initial project plan by detailing tasks, milestones and deliverables for Stage 1&Appropriateness of work plan\\
...
[X[3]X[6]X[6]]
 ...
 Reasons R& Early software testing while the hardware is still unavailable could reduce the late occurrence of errors and expensive redesign. & Late errors; redesign
\end{SimpleNColTable}
\end{running}
...
\chapter{Managing risk in Stage 1}%\label{sect:stage1ManagingRisk} -- old
...
\begin{itemize}
	\item writing down your reflection: to write down on a regular basis thoughts, emotions and insights from things you have done and experienced. You could use prompts, like `What did I learn today?, `What could I have done differently?, or `Which emotions did I experienced?' to guide your writing
	...
	\item considering ethical implication: to think about the ethical implications of your decisions, work and actions, and how they impact others, especially vulnerable people
	\item engage in dialogues with others: to gain different perspectives from, say, participants in your research or your peers, and gain a deeper understanding which includes several viewpoints.
\end{itemize}


\begin{question}[subtitle={Practicing reflexion and reflexivity on your project}]
In this activity you are asked to pause and reflect deeply on what you have leant and done as part of your studies, the wider context of your work and your own attitude to it. Specifically, you are asked to think deeply about each of the following:
