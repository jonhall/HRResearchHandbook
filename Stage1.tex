\chapter{Stage 1: Scoping your project}
...
In all research, but particularly at Masters where time is limited, it is important to establish the scope of your project early on: this is the focus of Stage 1. 


Stage 1 is fundamental as it gives you the solid foundation for the whole of your research project. As such it is an intense stage, where you will be expected to undertake the wide range of research activities summarised in Table~\ref{tab:stage1}. The table has entries for all but two of the research process activities that were introduced in Section~\ref{sect:researchactivities}. We did say that Stage 1 was intense!


\begin{table}[htbp]
\caption{Research activities addressed in Stage 1 (15\% of project length)\label{tab:stage1}}
\small
...
\midrule
 ...
 \textbf{Identifying the research problem} & initial research problem statement & be able to express a well-formed research problem & 15\% & suitability in relation to study requirements\\
 \textbf{Reviewing the literature} & summaries of literature reviewed, organised by theme & apply Keshav's process to assimilate the content of an academic paper; use a summary-comparison matrix to track the content of articles; use a concept matrix and concept map to identify emerging themes; write up summaries of the literature around emerging themes & 30\% & scope of literature review and remaining gaps \\
 \textbf{Setting your aim and objectives} & initial aim and objectives statement & be able to write appropriate research aim and objectives  & 5\% &  suitability and feasibility \\
 \textbf{Developing the research design} & kinds of data, evidence and methods your project may require; ethical considerations you will need to take into account & know the kind of data and methods used in research; know which ethical and legal issues may affect research & 10\% & ethical and legal regulations which apply to your studies \\
%\textbf{Gathering and analysing evidence} & n\slash a & & 0\% & \\
% \textbf{Interpreting and evaluating findings} & n\slash a & & 0\% & \\
\textbf{Reflecting} & your collection of thoughts about your own learning and practice & know the role of reflection in research & 10\% &  \\
 \textbf{Reporting} & Stage 1 report & be able to assess your research progress; be able to apply the given template to write up your Stage 1 report & 20\% &  improvements required \\
 \textbf{Planning work} & outlined work plan & be able to use Gannt chart (or similar) to produce a work plan & 5\% & suitability and possible adjustments \\
  \textbf{Managing risk} & summary risk table & know what risk is; know how risk can affect research; be able to assess risk in your project & 5\% & possible missing entries \\
\bottomrule
\end{tabulary}
\end{table}


Looking at the table, of the activities covered in this stage, \textit{Reviewing the literature} is the most demanding at 30\% of overall effort for this stage, closely followed by \textit{Reporting} at 20\% and \textit{Identifying the research problem} at 15\%, the former consisting in putting a report together after you have developed its constituent parts.
...
If your project is the capstone of a taught degree, you should ensure that the topic is appropriate to the degree you are studying. In many instances, this relevance will be obvious -- you may well be exploring a topic you have encountered in your degree.
...
\begin{quotation}
	In the context C, with phenomena of interest P, to address knowledge gap G. This matters to W because R.
\end{quotation}

An example of this could be:

\begin{quotation}
	In the context of `the food industry', with `plastic containers and wrappers' being the phenomena of interest, to address `the reduction in the use of plastic containers and wrappers.'  This matters to `the food industry and to society' because `10\% of all costs can be attributed to the use of plastic, and plastic is highly polluting'.
\end{quotation}
...
\textbf{Context C} & European commercial synthetic biology ecosystem \endfirsthead
\textbf{Phenomena P}   & The current state of the ecosystem \\
\textbf{Knowledge gap G}  & A characterisation of the present state the ecosystem \\                         
\textbf{Stakeholders S}  & Consumers and producers within the ecosystem  \\
\textbf{Reasons R} & To inform effective routes to commercialisation\\
\end{ltabulary}

\begin{ltabulary}{\textwidth} {@{}LL@{}}
\textbf{Context C} & UK organisations \endfirsthead
\textbf{Phenomena P}   & Those organisations' management of cloud-based IT services \\
\textbf{Knowledge gap G}  & How they use the ITIL framework to manage cloud-based IT services \\                         
\textbf{Stakeholders S}  & Those organisations' managers  \\
\textbf{Reasons R} & To improve service management\\
\end{ltabulary}
...
\begin{ltabulary}{\textwidth} {@{}LL@{}}
\textbf{Context C} & Public service providers \endfirsthead
\textbf{Phenomena P}   & End-users' demographic and behavioural factors; cyber security threats \\
\textbf{Knowledge gap G}  & To investigate the relation between demographic and behavioural factors and end-users' awareness of cyber security threats \\                         
\textbf{Stakeholders S}  & The providers and their customers \\
\textbf{Reasons R} & Successful cyber security attacks can result in loss of confidential information \\
\end{ltabulary}

\begin{ltabulary}{\textwidth} {@{}LL@{}}
\textbf{Context C} & Government organisations dealing with natural disasters \endfirsthead
\textbf{Phenomena P}   & Social media; the management of natural disasters \\
\textbf{Knowledge gap G}  & To investigate the possible use of social media in the management of a natural disaster \\                         
\textbf{Stakeholders S}  & Those government organisations  \\
\textbf{Reasons R} & Social media could be integrated within critical communication infrastructures\\
\end{ltabulary}
...
\begin{ltabulary}{\textwidth} {@{}LL@{}}
\textbf{Context C} & The public sector  \endfirsthead
\textbf{Phenomena P}   & Use of teleconferencing technology\\
\textbf{Knowledge gap G}  &  How practices adopted by organisations and employees lead to an effective and efficient use of teleconferencing technology\\                         
\textbf{Stakeholders S}  &  Public sector organisations\\
\textbf{Reasons R} & More and more business is conducted online\\
\end{ltabulary}

\begin{ltabulary}{\textwidth} {@{}LL@{}}
\textbf{Context C} & Software development companies \endfirsthead
\textbf{Phenomena P} & Learning strategies; skills development   \\
\textbf{Knowledge gap G} & How learning strategies adopted by software engineers allow them to develop new skills fast and efficiently  \\                         
\textbf{Stakeholders S}  &  Software development companies and software engineer\\
\textbf{Reasons R} & Software technology changes rapidly, so that software engineers need upskilling and retraining very frequently\\
\end{ltabulary}
...
Predictive problems aim to predict future phenomena. The goal is usually to define a model, extrapolating from current knowledge, that allows predictions to be made together with an assessment of how accurate they might be.
...
\begin{ltabulary}{\textwidth} {@{}LL@{}}
\textbf{Context C} & UK in the next decade \endfirsthead
\textbf{Phenomena P}   & Fresh water consumption; recycling domestic bathroom water \\
\textbf{Knowledge gap G}  & To quantify the potential impact on fresh water consumption of recycling domestic bathroom water \\                         
\textbf{Stakeholders S}  &  Water management agencies; water suppliers and consumers\\
\textbf{Reasons R} & Preserving fresh water is important as it is becoming a scarce resource\\
\end{ltabulary}

\begin{ltabulary}{\textwidth} {@{}LL@{}}
\textbf{Context C} &  Higher Education \endfirsthead
\textbf{Phenomena P}   & Student drop-outs; Demographic and curriculum data\\
\textbf{Knowledge gap G}  & To predict which current students are at risk of dropping out \\                         
\textbf{Stakeholders S}  & Universities; their students  \\
\textbf{Reasons R} & Student retention is a statutory duty; retentions means that enough skilled people enter the job market\\
\end{ltabulary}
...
\begin{ltabulary}{\textwidth} {@{}LL@{}}
\textbf{Context C} &  The financial sector\endfirsthead
\textbf{Phenomena P} & AI techniques and cyber security attacks   \\
\textbf{Knowledge gap G}  & To evaluate the effectiveness of AI in reducing successful cyber-security attacks \\                         
\textbf{Stakeholders S}  & Operators in the sector and their customers \\
\textbf{Reasons R} & Significant financial losses are due to such attacks every year, and the cost of preventing them is high\\
\end{ltabulary}

\begin{ltabulary}{\textwidth} {@{}LL@{}}
\textbf{Context C} & Non clinical laboratories \endfirsthead
\textbf{Phenomena P}   & Lean techniques; process flow; demand and supply\\
\textbf{Knowledge gap G}  &  To determine if lean techniques can improve process flow in the presence of unpredictable demand and supply \\                         
\textbf{Stakeholders S}  &  Those laboratories and their customers\\
\textbf{Reasons R} & Inefficiencies in process flow are costly\\
\end{ltabulary}
...
\begin{ltabulary}{\textwidth} {@{}LL@{}}
\textbf{Context C} & Data visualisation tool development industry \endfirsthead
\textbf{Phenomena P}   & Text summaries; multiple time series line graphs; algorithms\\
\textbf{Knowledge gap G}  & To devise algorithms able to generate automatically text summaries of line graphs depicting multiple time series \\                         
\textbf{Stakeholders S}  & Tool providers and sight-impaired end-users \\
\textbf{Reasons R} & To improve the accessibility of such tools\\
\end{ltabulary}

\begin{ltabulary}{\textwidth} {@{}LL@{}}
\textbf{Context C} &  Embedded software systems development sector\endfirsthead
\textbf{Phenomena P}   & Complexity and volatility characteristics; project failure; project management\\
\textbf{Knowledge gap G}  &  To define a hybrid project management framework, based on complexity and volatility characteristics, to reduce project failure\\                         
\textbf{Stakeholders S}  &  Project managers in the sector\\
\textbf{Reasons R} & Project failure rate is high, resulting in a high financial burden for the sector\\
\end{ltabulary}
...
\subsection{How to access the literature}\label{sect:howToAccessTheLiterature}
...
Keshav's approach is summarised in Table~\ref{tab:Keshav}.
...
\begin{tabulary}{\textwidth}{@{}LLLLL@{}} \toprule
 \# & Time & What to read or do & What you should know after the pass & Criteria for stopping at current pass \\
\midrule
 ...
 2 & 1 hour & Jot down key points, comments, questions; Mark relevant unread references & Main thrust of the paper with supporting evidence & Paper of interest but not key to your research \\
 3 & $>$1hour & Virtually reimplement the paper; Identify\slash challenge assumptions  & New knowledge contributed; Strong\slash weak points, implicit assumptions, missing citations, potential issues; Insight into complex arguments and presentation techniques; Jot down ideas for future work  &  \\
\bottomrule
...
%The illustration in Figure\ref{fig:pacman} might help.
%
%\begin{figure}[htbp]
...
\toprule
 \textbf{Problem element} & \textbf{From problem statement} & \textbf{Our brainstormed search terms} \\
\midrule
...
\begin{question}[subtitle={Activity: Search terms brainstorming}] Using your research problem, fill in a table similar to that in the example, indicating few search terms you have brainstormed for each research problem element.
...
\paragraph{Method} To address the above need, we conducted and report in this paper a systematic literature review (SLR) in the form of a systematic literature mapping (SLM) in this area. After compiling an initial pool of 588 papers, a systematic voting about inclusion\slash exclusion of the papers was conducted among the authors, and our final pool included 312 technical papers.
...
\paragraph{Conclusion} The results of this review paper have already benefitted several of our industry partners in choosing the right test techniques/approaches for their embedded software testing challenges. We believe that it will also be useful for the large world-wide community of software engineers and testers in the embedded software industry, by serving as an ``index'' to the vast body of knowledge in this important area. Our results will also benefit researchers in observing the latest trends in this area and for identifying the topics which need further investigations.}
...
A summary-comparison matrix\footnote{This term is used in Sastry and Mohammed (2013), although another term used online is `literature matrix.'}is a useful tool to track the content of academic articles in a way which also makes it easier to compare the articles you have read. 
...
\begin{itemize}
	...
	\item Research problem\slash question: your understanding of the research problem or question(s) the reported research aimed to address
	\item Research methods\slash approach: how the authors conducted their study. Don't worry if you don't understand all the details at this point: we will return to research methods in Stage 2
	\item Known facts\slash assumptions\slash definitions\slash gaps at start: these are the premises of the study, that is arguments or evidence on which it relies upon
	\item Key findings\slash contribution made: what the study has contributed in terms of advancing knowledge in the field of study
...
\begin{question}[subtitle={Activity: Using a summary-comparison matrix for the Keshav's paper}] Create a summary-comparison matrix with the columns recommended above, and fill in its first entry in relation to the Keshav's paper you considered in Section~\ref{sect:Keshav}.
...
Carrying on with our example, we have highlighted a number of concepts in our summary-comparison matrix, as shown in Figure~\ref{fig:highlightedConcepts}, from which we have constructed a concept matrix, a small extract of which is given in Figure~\ref{fig:exampleCMatrix}
...
\begin{guidance}
We could start by applying the heuristics from the example to identify and highlight concepts in your summary-comparison matrix, but do not be constrained by them, and feel free to come out with other heuristics to guide your choices. Expect to go over each entry a number of times before reaching the set of concepts you wish to focus on.
\end{guidance}
\end{question}
%%Hack to correct tcbox behaviour
\color{black}
...
To find common themes you will need to exercise both judgement and creativity, and the tool we recommend you use is a \textit{concept map}: this is a diagram or graphical tool where you can represent visually concepts and their relationship. To produce your map you could use a drawing package, or a physical board. What matters is that the tool you use should allow you to 'move things around' to explore different ways to relate and group your concepts. 
...
\begin{itemize}
	\item Objective 1: To \emph{identify} a set of techniques that can be used to model students' study trajectories
...
\subsection{Equity, Diversity and Inclusion in research}
...
\subsubsection{Bias in research}\label{sect:biasInResearch}
...
\subsubsection{Use of generative AI in research}
...
Even with these drawbacks, generative AI can be a useful tool in research, particular to get you started on specific tasks, like gathering some initial information on a particular topic, identifying some initial articles to read, or even summarising certain literature, as long as you then put your own effort and work to generate your own content which is both authentic, unbiased and creative. 
...
\begin{question}[subtitle={Activity: Understanding your university's guidelines on generative AI}] Using your university's intranet look up any policy or guideline related to the use of generative AI. Write a brief summary of what you have found out which may be relevant to your Masters project work.
\begin{solution} 
...
\begin{itemize}
	...
	\item to help with spelling and grammar in written text, and generally to help your improve your writing skills,
...
\section{Reflecting}\label{sect:stage1Reflection}
