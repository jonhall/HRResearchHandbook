...
It is now time to write down Clara's problem, by using the template we have provided, and based on what we have found out so far, which is summarised in~\Cref{tab:claraproblemelements}.
...
\begin{question}[subtitle={Activity: Clara's initial problem}] Based on the information in~\Cref{tab:claraproblemelements} and using the problem template, write down Clara's initial research problem.
...
\section{Types of research problems}\label{sect:Types}
...
\chapter{Setting research aim and objectives}\label{sect:stage1AimAndObjectives}\label{ch:SettingResearchAim}
...
\section{Articulating your research aim}\label{sect:Articulating}
...
\chapter{Managing risk in Stage 1}\label{sect:stage1ManagingRisk}\label{ch:ManagingRiskIn}
