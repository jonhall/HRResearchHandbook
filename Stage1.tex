...
Your research should be of interest to academics in the field, who are conducting related research, as witness, for instance, by their publications in the academic literature: some of your findings may well contribute to their future research.
...
In this section, we'll be looking at how to read an academic paper. It may seem strange to think about trying %\footnote{Searching comes next, promise!} 
	to read an academic article without having found any first! It's such an important skill, however, that it needs introducing early, and in a way that we can coach you through it the first time. Honestly\footnote{And not just for your research project. Reading the academic literature is a professional skill that not many professionals have.}, it's going to take some time to pick up this skill, but it's an investment worth making. 
...
Firstly, the time suggested for each pass is only an approximation, and will depend on your own skills and previous experience of reading the academic literature, whether the subject matter is new to you, or even that the article may be poorly written and difficult to follow. 
...
Each academic paper is characterised by bibliographical information, including its title, its authors and their affiliation, where and when it was published and its length in pages. Other information may also be included, like a Digital Object Identifier (DOI)\footnote{A unique alphanumerical string which provides a persistent link to a resource on the internet.} or a web link to where it can be found in an online repository. Several bibliographical styles are used in the academic literature to express bibliographical information%\todo{These references need generating automatically, if possible.}.
...
\begin{SimpleNColTable}{tab:conceptsOfInterest}{2}[\narrowtablewidth]{Concepts of interest}[R[5]R[4]]
 ...
 {~\textbullet~Whom does it affect?}&\SetCell[r=3]{m}Establishing the problem's significance, stakeholders, and beneficiaries \\
...
\begin{itemize}
	\item Your title will be your first attempt at capturing your research problem and aim as you currently understand it. This understanding will increase during your project, particularly as you review more and more academic literature, so expect to revise your title in follow-up stages
...
\item The academic literature is the main vehicle for the codification and sharing of academic knowledge
\item In stage 1, your review of the academic literature should help you frame, contextualise and justify your chosen topic and research problem
\item You can access the academic literature conveniently through online bibliographical databases, including those provided by your university library and google scholar
