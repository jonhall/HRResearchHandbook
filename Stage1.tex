...
For this reason, in Stage 1, we will not consider research design in detail --- that will happen in Stage 2 instead. However, so that you can start to think about your research design, in this section, we introduce some basic definitions around evidence and research methods, and then focus on ethical and legal matters in research.
...
It is important to embed EDI principles within your project. Failing to do so may lead to studies whose results are not applicable, or are even detrimental, to particular groups of people. For instance, medical trials in which some groups are under-represented may lead to treatments which are not effective for those groups.
...
\subsubsection{Regulations governing animal research}
%to do
Although it is rarely the case at Masters level, your research may involve animals...
...
%LR - to revise or maybe remove and add something under the Reporting section at the end instead
