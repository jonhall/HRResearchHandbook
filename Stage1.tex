...
\begin{SimpleNColTable}{tab:descriptiveProblemsB}{2}[\the\textwidth]{Description Problems  – Example 2}
...
\begin{SimpleNColTable}{tab:keshavBibdata}{2}{Bibliographic database entry for \citeauthor{keshav2007read}, \citeyear{keshav2007read}}[{X[1]X[3]}]
\relax\\
...
\begin{SimpleNColTable}{tab:conceptsOfInterest}{2}{Concepts of Interest}[X[3]X[8]]
...
Some IP gives rise to specific rights which are protected by law\footnote{For instance, the UK Intellectual Property Act 2014 (\href{https://www.legislation.gov.uk/ukpga/2014/18/contents/enacted}{https://www.legislation.gov.uk/ukpga/2014/18/contents/enacted}) defines a number of IP rights, establishing whom they belong to and what they allow the owner to do.}.
