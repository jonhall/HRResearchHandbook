...
It is now time to start writing! Each theme you have identified includes enough materials for you to start summarising what you have found in the literature under that theme. Later on, you will be using these summaries as building blocks towards writing up your literature review draft.
  
\begin{example}{Writing a summary for an identified theme}
With the information we have analysed and synthesised, we can attempt a summary for each identified theme. For instance, considering `modelling study pathways', we have produced the following summary:

\textit{Several authors have considered modelling and analysing students' learning trajectory through a programme of study, in order to understand how students progress or otherwise through their study and the learning outcomes they achieve in doing so. Such an understanding can then be use to inform scholarship and reflection around curriculum and its design, and inform possible changes. 
...
\subsection{Revising your research problem}
%stopped here on 19th Oct, 2pm
...
\begin{example}{Clara's research } Going back to Clara's example, you may recall that Clara had identified the following problem after her initial review of the literature:
...
\subsection{The rights of research participants<Is it worth asking Clara for examples of ethical research including animals?>}
...
\subsection{Processing personal data}
...
\subsection{Your responsibility as an ethical researcher
}
