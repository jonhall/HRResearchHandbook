...
\begin{SimpleNColTable}{tab:keshavBibdata}{2}[\narrowtablewidth]{Summary-comparison matrix entries for \textcite{keshav2007read}}[lR[4]]
...
Contribution & a practical approach to help researchers engage with the content of an academic articles effectively and efficiently; an outlined process for reviewing the literature based on the approach \\
...
\begin{SimpleNColTable}{t:exampleCMatrix}{4}[\the\narrowtablewidth]{Example of concept matrix entries}[R[3]R[3]R[3]R[3]]
...
GDPR defines \gls{personal data} as any information which may identify a living person, be that a name or a personal identification number, or a combination of physical characteristics, or cultural or social identities, and establishes rules for the use of such data.

It also establishes particular legal protection or safeguards for \gls{sensitive personal data}, that is, data which may reveal:
...
\begin{solution}
Our university upholds GDPR regulations for all research. The use of personal data in research must be declared and permission to proceed obtained from and academic board. At Masters level, research students are not allowed to make use of sensitive personal data in their projects.
\end{solution}\end{question}
%%Hack to correct tcbox behaviour
\color{black}
...
Writing up your report is an excellent way to consolidated the work you have completed and that you are still planning to do, and is something tangible you can share with your supervisor for feedback and guidance.
