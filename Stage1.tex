...
Each academic paper is characterised by bibliographical information, including its title, its authors and their affiliation, where and when it was published and its length in pages. Other information may also be included, like a Digital Object Identifier (DOI)\footnote{A unique alphanumerical string which provides a persistent link to a resource on the internet.} or a web link to where it can be found in an online repository. Several bibliographical styles are used in the academic literature to express bibliographical information.
...
\item a Bibliographical Management Tool (MMT) is a very useful support tool when doing a literature review. It helps you organise and keep track of articles you have reviewed alongside your notes and summaries
