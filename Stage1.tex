...
\item \textbf{Interval} data are ordinal data, but for which we can know the distance between any two data points. For instance, calendar dates are interval data in the sense that they can be arranged in an order and we can calculate the time interval between two given dates, e.g., the number of days in between.
