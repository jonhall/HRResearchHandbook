...
\input{WritingActivities/Stage1}
...
\begin{SimpleTwoColTable}[Elements of Clara's problem\label{tab:claraproblemelements}]
Context C & Clara's engineering plant and planning department \\
Phenomena P & Forecasting of time and resources and its accuracy \\ 
Knowledge gap G & How to improve the accuracy of forecasting \\
Stakeholders S & Clara's company \\
...
\begin{SimpleFiveColTable}[{Summary of Keshav's approach --- adapted from the 2013 revision of Keshav (2007)\label{tab:Keshav}}]
...
\begin{SimpleFourColTable}[Key activities in reviewing the literature, including key skills required\label{tab:litrevactivities}]
...
\begin{SimpleTwoColTable}[Boolean operators for search terms\label{tab:booleanoperators}]
 Boolean operator & Effect of the search \\
\enquote{Term 1} AND \enquote{Term 2} & Materials containing both Term 1 and 2 will be returned. This is used to narrow down a search. \\
\enquote{Term 1}'' OR \enquote{Term 2} & Materials containing only Term 1 or only Term 2 or both will be returned. This is used to expand a search. \\
 NOT \enquote{Term 1} & Materials not containing Term 1 will be returned. This is used to narrow down a search. \\
\end{SimpleTwoColTable}
...
\begin{SimpleTwoColTable}[Bibliographic database entry for \citeauthor{keshav2007read}, \citeyear{keshav2007read}][{X[1]X[3]}]
\relax\\
...
\begin{SimpleTwoColTable}[][X[3]X[8]] 
...
\begin{SimpleFiveColTable}[Risk table \label{tab:riskTable}][X[3]X[1]X[1]X[1]X[1]]
\\
 Technical skills & & & &  \\
 Study time & & & &  \\
 Resources & & & & \\
...
\begin{SimpleTwoColTable}[Recommended structure of your research proposal \label{tab:researchProposalStructure}][X[-1]X[4]]
...
\begin{SimpleTwoColTable}[Criteria for reviewing your research proposal \label{tab:criteriaForResearchProposal}]
Criteria & Prompts \\
