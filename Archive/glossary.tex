...
\newglossaryentry{alternative hypothesis}{ name={alternative}, description = {{\color{red}???}}, plural = {alternative hypotheses}}
\newglossaryentry{analysis method}{ name={analysis method}, description = {a method used to analyse data}}
...
\newglossaryentry{beneficiary}{ name={beneficiary}, plural = {beneficiaries}, description = {\color{red}???}}
\newglossaryentry{bell curve}{ name={bell curve}, description = {\color{red}definition needed}}
\newglossaryentry{bias weakness}{ name={bias weakness}, plural={bias weaknesses}, description = {when the claim you have made to new knowledge has been affected by your implicit or explicit biases, or bias affecting human participants in your study, making the new knowledge invalid}}
%%*******to here
\newglossaryentry{bias}{ name={bias}, plural={biases}, description = {a tendency to support or oppose particular ideas or things based on personal preferences rather than objective evidence}} 
