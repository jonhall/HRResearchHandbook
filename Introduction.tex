...
\subsection{Masters level research}
...
\subsection{What you will have achieved as a Masters' graduate}
...
\section{The role of a supervisor}
...
\subsection{Bibliographic management tools}
...
\subsection{Keeping track of your digital assets}
...
\subsection{Managing document versions}
...
\subsection{Choosing the right word processor}
...
\section{Introduction Takeaways}
...
\item your supervisor is your best ally and you should establish an effective working relationship from the start
...
\item there are key skills (see Section~\ref{Sect:keySkills}) you must develop and practice from the onset 
