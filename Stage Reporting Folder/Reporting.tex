...
\SetTblrInner[reportblr]{measure=vbox, stretch=-1,%Allows lists in body
  hline{even} = {brown8,wd=2pt}, %column{2} = {co=1}, 
  colsep = 5pt,
  row{odd} = {brown8},% row{even} = {gray8},
  row{1} = {fg=white, bg=purple2, font=\bfseries\sffamily},
  column{1} = {fg=white, bg=purple2, font=\bfseries\sffamily},
  rowhead = 1,
  colspec={X[8,l]X[24]X[1,c,wd=22pt]}
}
...
%Part/Structure&Guidance&Ref(s)\\
%\reportheader Title\\ 
%& Your title should capture succinctly your research problem and aim. You should refer back to Section~\ref{sect:title} for more guidance&\\
%
%\reportheader Introduction\\ 
%\begin{reportenum}%[start=0,label={(\bfseries R\arabic*):}]
%\item [1.1] Background to the research 
...
%\item [3.3] Knowledge contribution 
%\end{reportenum}
%& You should ensure that your research problem is well articulated, that your aim and objectives are consistent with the research problem, and that the intended knowledge contribution of your research is clearly argued. You should refer back to the activities you conducted in Sections~\ref{sect:stage1ResearchProblem} and \ref{sect:stage1AimAndObjectives}, but also to the theme summaries you produced at the end of Section~\ref{sect:stage1LiteratureReview}, particularly those which highlight knowledge gaps of interest& \\
% 
% \reportheader Research design\\ 
% \begin{reportenum}%[start=0,label={(\bfseries R\arabic*):}]
%\item [4.1] Evidence and data 
...
\reportheader Literature review\\
\begin{reportenum}
\item [2.1]Review of existing relevant knowledge 
\item [2.2]Critical summary, including knowledge gap to be addressed by the research 
\end{reportenum}
...
\begin{reportenum}
\item [3.1]Problem statement 
\item [3.2]Aim, objectives, tasks and deliverables
\item [3.3]Knowledge contribution
\end{reportenum}
...
\begin{reportenum}
\item [4.1]Evidence and data 
\item [4.2]Research strategy and methods
\item [4.3]Research procedures
\item [4.4]Ethical, legal and EDI considerations
\end{reportenum}
...
\reportheader Assessment of your proposed research\\
\begin{reportenum}
\item [6.1]Qualification fit
\item [6.2]Personal and professional fit
\item [6.3]Technical skills and resources needed
\item [6.4]Statement of feasibility
\item [6.5]Personal reflection on research process
\end{reportenum}
...
\reportheader Planning, scheduling and risk assessment\\
\begin{reportenum}
\item [7.1]Key priorities in follow-up stage
\item [7.2]Personal and professional fit
\item [7.3]Risk assessment
\end{reportenum}
...
\reportheader Appendix A: Work schedule\\
	& Your revised work plan&\\
	
\reportheader Appendix B: Risk assessment table\\
	& Your revised risk table&\\
\end{reportblr}
\end{document}
