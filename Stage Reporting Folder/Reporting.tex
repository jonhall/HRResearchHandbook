...
\SetTblrInner[reportblr]{measure=vbox, stretch=-1,%Allows lists in body
  ...
  column{1} = {fg=black, bg=azure8, font=\bfseries	\sffamily},
  rowhead = 1,
...
\begin{reportblr}{}
Part/Structure&Writing goals&Ref(s)\\
\reportheader Title\\
...
\end{reportenum}
%
 & In this section you should reflect on the progress you have made in Stage 1 in relation to your initial work plan and establish your priorities for the next stage. For this, you should revise your initial work plan (\ref{sect:stage2WorkPlan}) accordingly. You should also summarise the outcome of your project risk assessment (\ref{sect:stage2ManagingRisk}).
 &\ref{sect:stage2WorkPlan} \ref{sect:stage2ManagingRisk}\\
\end{reportblr}
...
\end{reportenum}
%
 & In this section you should reflect on the progress you have made in Stage 1 in relation to your initial work plan and establish your priorities for the next stage. For this, you should revise your initial work plan (\ref{sect:stage3WorkPlan}) accordingly. You should also summarise the outcome of your project risk assessment (\ref{sect:stage3ManagingRisk}).
 &\ref{sect:stage3WorkPlan} \ref{sect:stage3ManagingRisk}\\
\end{reportblr}
%\end{document}
...
\end{reportenum}
%
 & In this section you should reflect on the progress you have made in Stage 1 in relation to your initial work plan and establish your priorities for the next stage. For this, you should revise your initial work plan (\ref{sect:stage4WorkPlan}) accordingly. You should also summarise the outcome of your project risk assessment (\ref{sect:stage4ManagingRisk}).
 &\ref{sect:stage4WorkPlan} \ref{sect:stage4ManagingRisk}\\
\end{reportblr}
