...
\centering
\small
\caption{Distinguishing between description, analysis, synthesis and evaluation academic writing. (Adapted from \textcite{Cottrell2005}.)\label{tab:synthesis}}
