...
The research activities which are in focus in Stage 2 are shown in~\Cref{tab:stage2}, which also provides some guidelines for your interaction with your supervisor during this stage. As you can see, the focus of this stage is on completing your literature review and developing your understanding of the basic blocks of research design.

\subsection{Your Research Activities for this stage}

\todo{More here}

\begin{SimpleThreeColTable}[\RActivitiesTableCaption{2}\label{stage2ResearchActivities}][X[1]X[2]X[2]]
...
\chapter{Writing a full draft of your literature review}\label{sect:stage2literatureReview}\label{ch:WritingAFull}
...
\begin{SimpleFourColTable}[Types of academic writing (adapted from \textcite{Cottrell2005})\label{tab:kindOfAcademicWriting}][X[1]X[1]X[1]X[1]]
...
Your writing should be based on well-formed arguments, i.e., on claims that are supported by evidence\footnote{Either that of others or that you have discovered yourself. We look at academic arguments in detail in~\Cref{sect:arguments}.}, on comparing and evaluating alternative arguments, and on forming judgements on the basis of that evidence. Your writing will therefore favour analysis, synthesis and evaluation over descriptions.
...
\begin{SimpleTwoColTable}[\enquote{Signal words} used in academic writing, inspired by \textcite{Cottrell2017}\label{tab:signalwords}]	
...
Their model is shown in~\Cref{fig:argument}, and the parts are:
%
%
...
\blockquote{
	\BCW{showing violence on TV should  be allowed only after the 9pm}{TV violence can have harmful psychological effects on children}{Smith (1997)\textcite{Smith1997} found that children ages 5–7 who watched more than three hours of violent television each day were 25 percent points more likely to say that what they saw on television was ``really happening''}{that if children are protected from watching violence on TV they will be less likely to see violence as a normal part of day-to-day life}{\begin{itemize}\item that a child interprets something on TV as ``really happening'' does not necessarily mean that they will try to emulate it. 
\item Not all children are impressionable. 
\item Violence \textit{is} a normal part of day to day life.
\end{itemize}}}
\end{solution}
...
\begin{SimpleTwoColTable}[Criteria for assessing your literature review\label{tab:litrevcrit}]
Criteria & Prompts \\
...
Format and proof reading & Have you reviewed your writing carefully to remove typos and grammatical errors? Are all citations and references in correct bibliographical style? \\
...
Other help might come from family members/friends/colleague that you can talk to. Like you did in Activity~\Cref{act:???}, read what you have out loud to a live listener and have them try to follow your arguments. 
...
It is important to note that although we have tried to characterise this paradigm in relation to ontology, epistemology and methodology, some scholars reject any such classification, regarding this too as a form of colonialism imposed by a Western view of research paradigms. If you are interested in going more deeply into this debate, you could start from \cite{??}\todo{add references: Hart, M. A. (2010). Indigenous Worldviews, Knowledge, and Research: The Development of an Indigenous Research Paradigm. Journal of Indigenous Voices in Social Work, 1(1).}.
...
\begin{SimpleEightColTable}[Summarising research paradigms\label{tab:researchParadigms}]
...
\section{Research strategies}\label{sect:ResearchStrategies}
...
%Those you will encounter in this book are summarised in Figure~\ref{fig:strategiesAndMethods}: we will look at them in detail in Stages 3 and 4.
%
%\begin{figure}[htbp]
%\centering
...
The choice of research strategies and methods to apply is motivated and justified by the different mindsets you encountered in Section~\ref{sect:mindsets}: although practically you could apply them without referencing such mindsets, it is important for you as a researcher to be aware of the beliefs and values they embody, and the extent they align to your own -- something which will influence your own research design choices. 
...
\begin{SimpleThreeColTable}[Research methods discussed in this book\label{tab:methodsSummary}]
Type & Name & Description\\
Generation
 & \emph{Observations\slash measurements} & direct observation\slash measurement of phenomena of interest \\ 
...
In this book, we class methods as generation, analysis and modelling methods, as summarised in Table~\ref{tab:methodsSummary}. Briefly:
...
\begin{question}[subtitle={Activity: Research methods discussed in this book}] Consider the methods in Table~\ref{tab:methodsSummary}. Read their brief description and make a note of those you find potentially suitable for your project.  
\begin{guidance}
...
Each research discipline and area has its more-or-less well-worn paths to a successful knowledge contribution and has devised strategies to do so. The research strategies we discuss in this book are summarised in Table~\ref{tab:strategiesSummary}. 
...
\begin{question}[subtitle={Activity: Research strategies discussed in this book}] Consider the strategies in Table~\ref{tab:strategiesSummary}. Read their brief description and make a note of those you find potentially suitable for your project.  
\begin{guidance}
...
\begin{SimpleTwoColTable}[Research strategies discussed in this book\label{tab:strategiesSummary}]
Name & Used to \\
...
\begin{SimpleTwoColTable}[Research strategies introduced in this section\label{tab:resstrat}]
Name & Description \\
...
Experimental research & to investigate cause and effect relationships between factors by testing hypothesis or proving\slash disproving causal links\\
...
\chapter{Managing risk in Stage 2}\label{ch:ManagingRiskIn}


\chapter{Reflecting and reporting in Stage 2}\label{ch:ReflectingAndReporting}
...
\begin{SimpleTwoColTable}[Report structure and guidance guidance\label{tab:S2report}]
...
\begin{SimpleTwoColTable}[Criteria for reviewing your research proposal \label{tab:criteriaForStage2report}]
