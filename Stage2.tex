...
\BCW{\textit{my claim}}{\textit{my reasons}}{\textit{this evidence}}{\textit{my warrant}}{\begin{itemize}\item\textit{qualification 1}\item \item qualification 2 \item ...\end{itemize}}
...
%
\paragraph{Rule 1 of argument sequences:} \textit{no earlier argument will depend on a later argument}.

That's it. With this rule, you're making your readers' job easier: when they come to try to understand your later argument they will have everything they need to have to do so.

Of course, the perfect argument doesn't always exist – arguments can be circular\footnote{Circular arguments aren't great in terms of when they say about the logic by which they're constructed, but do sometimes happen.}. 

\begin{example}{A circular argument}
Let's look at a circular argument:
...
\begin{description}%[label={Premise \arabic*:}]
\item [Claim 1] Small businesses are required for an economy to function.
\item [Reason 1]Small businesses employ people and strengthen the economy.
\end{description}

\begin{description}
\item [Claim 2] A working economy is required for a small business to function.
\item [Reason 2]A working economy is more able to provide the investment that allows small business to grow.
\end{description}

In this argument small business and entrepreneurs are both the cause of a working economy and the consequence of one.
\end{example}

Thing is, there is an actual circular relationship between small business and economies – that they support each other is often the reason why an economy  grows. The problem for us is that we can't we need to consult an economist for a more valid explanation for why this circularity exists.\footnote{Adapted from \url{https://helpfulprofessor.com/circular-reasoning-fallacy-examples/}}
...
{\color{red}More guidance needed?}
%
\begin{itemize}
\item Draw a mind map of the arguments you have developed and how they relate to each other. Use the map to group and sequence the arguments in your outline\footnote{Try overlaying your arguments onto a pacman – place the more detailed ones closer to the `mouth'. Once you're happy with their positioning, you can use that to order them.}
