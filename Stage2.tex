...
The research activities which are in focus in Stage 2 are shown in~\Cref{stage2ResearchActivities}, which also provides some guidelines for your interaction with your supervisor during this stage. As you can see, the focus of this stage is on completing your literature review and developing your understanding of the basic blocks of research design.

\subsection{Your Research Activities for this stage}

\todo{More here}

\begin{SimpleNColTable}{stage2ResearchActivities}{3}{\RActivitiesTableCaption{2}}[X[1]X[2]X[2]]

Research activity&Description&Interaction Focus\\
Identifying the research problem&Adjust, if needed&\\
Reviewing the literature&{Complete full draft of literature review\\
...
Critical thinking in driving insights}\\
Setting research aim and objectives&Adjust, if needed&\\
Developing the research design&{Revise research design, with detailed consideration of data and evidence, research strategy and research methods\\}&Any further adjustment needed to the research design\\
Gathering and analysing evidence&n/a&\\
Interpreting and evaluating findings&n/a&\\
Reporting&Write up Stage 2 report&Any further improvements required\\
...
Planning work&{At stage start, plan Stage 2 work in detail, including any revision or additional work needed from the previous stage.\\}&Any major adjustment required\\
Managing risk&Review project risk and make any required adjustments for the next stage&Any major adjustment required
\end{SimpleNColTable}
