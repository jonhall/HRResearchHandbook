...
\Gls{accidental plagiarism} resulting from poor academic practices is addressed by providing extra study support, particularly early on in a programme of studies. However, repeated offences will incur in disciplinary action, as per intentional plagiarism.
\end{solution}\end{question}
%%Hack to correct tcbox behaviour
\color{black}

\section{Develop your arguments!}\label{sect:DevelopYourArguments}
The development and presentation of academic arguments forms the core of academic writing. But what exactly is an academic argument? To answer this question, we look at the model proposed by Booth, Colomb and Williams in \textcite{booth1995making}; we will refer to this as the \gls{bcw model}. 
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{argumentParts.png}
...
Firstly, there may be \gls{logical fallacies} in your arguments: these are errors of reasoning that can undermine your claim. The most common ones are\footnote{Many more exist -- you may like to do a web search to find out more.}:
...
We do research to make a contribution to knowledge. Practically, to do research, we combine a number of research tasks into a framework. Designing such framework is what we term \gls{research design}. The framework will depend on the research area, the type of knowledge contribution you wish to make, your mindset as a researcher, and the opportunities and difficulties you may face along the way.

A research framework has many levels. At its foundations are its \gls{ontology}, \gls{epistemology}, and \gls{methodology}: 
...
In moving away from objective knowledge, however, \gls{anti-positivism} raises questions of research validity\footnote{We will discuss validity in the next section.}, that is of how trustworthy and generalisable knowledge generated as subjective interpretation might be. 
...
&  Positivism & \Gls{Post-positivism} & \Gls{anti-positivism} & Constructivism & Critical theory & Indigenous \\
...
Mathematical thinking &  problem solving approach aimed at mathematical solutions to problems\\
Statistical thinking & problem solving approach aimed at statistical solutions to problems, particularly for prediction and forecasting\\
...
\begin{itemize}
	\item \gls{generation methods} are used to generate data. You can apply them to generate primary data from phenomena you observe in the real-world or from the people participating in your research
	\item \gls{modelling methods} are used to build models of complex real-world situations, which can then be used to generate further data. For instance, you may want to predict how a new aircraft you are designing is likely to respond to severe wether conditions: you can do this safely by building a model of the aircraft and testing it under various meteorological conditions
