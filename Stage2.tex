...
Thing is, there is an actual circular relationship between small business and economies – that they support each other is often the reason why an economy  grows. The problem with this circular argument is that it tries to separates a single argument into two. Unresolvable circular arguments are often the result of trying to do this and so point to some additional thinking that is needed.
