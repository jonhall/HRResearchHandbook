...
\subsubsection{Logical fallacy and cognitive bias}

The BCW model is a useful device to help identify and structure the key elements of your academic arguments. In making you think deeply and critically about what you are trying to claim, you have a better chance to write good argument.

There are, however, things you need to guard against. 

The first is logical fallacies, that is mistakes in reasoning which can undermine the logic of your arguments. 
