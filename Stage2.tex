...
\input{Tables/ResearchActivities/Stage2}
...
You must be able to draw links between the articles that you have found, a process you started in Stage 1 by constructing a summary-comparison matrix\footnote{Refer back to Section~\ref{sect:Stage1AssimilatingAndAnalysing} if necessary.} and identifying emerging themes.
...
\section{Researcher mindsets}\label{sect:mindsets}
