...
%
\begin{itemize}
\item [\color{red}Added] Draw a mind map of the arguments you have developed and how they relate to each other. Use the map to group and sequence the arguments in your outline\footnote{Try overlaying your arguments onto a pacman diagram – place the more detailed ones closer to the `mouth'. Once you're happy with their positioning, you can use that to order them.}
...
\begin{question}[subtitle={ACTIVITY: Checkpoint: Sharing your literature review with your supervisor}] Before going further with your literature, it would be wise to ask your supervisor for comments on what you have already achieved. 
...
%
\begin{itemize}
\item \enquote{you should read the following papers}
\item \enquote{this section seems out of order, perhaps it would be better here}
\item \enquote{you've missed this topic}
\item \enquote{it would be better expressed this way}
\item \enquote{other comments}
\item \enquote{your conclusions are wrong}
\item \enquote{speak to this colleague before proceeding}
\item more here
\end{itemize}

Carefully gather any and all feedback you receive and follow it carefully to identify and carry out all remaining work to develop a full draft of your literature review.

\begin{guidance}You know what supervisors really like? They like you to take their comments seriously. We don't mean just taking note of what they say and implementing it, but – and this is a good habit to form – writing a response: for each of their comments say \enquote{Thank you} and saying how the literature review changed because of it. Your response doesn't have to be long – the shortest comment could be \enquote{Thank you, done!}. Doing this will make them feel really valued. 

In this stage, synthesis, critical reflection and academic writing will be more prominent than searching, reading and assimilating content, so that you will need to pay particular attention at how the structure and narrative of your literature review develops as you incorporate more materials.
