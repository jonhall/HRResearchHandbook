...
ML modelling too requires highly developed technical knowledge and skills, which you should already possess, or have the time to develop, if you are considering their use in your Masters project.
...
\subsubsection{Summary of research strategies}
Table~\ref{tab:resstrat}\todo{Table needs to break across pages}
 provides a summary of research strategies introduced in this section. As you did for methods, in the next activity you should reflect on those which are most relevant to your project.
...
\subsection{Understanding research design}
