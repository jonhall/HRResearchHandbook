...
While in Stage 1 your main focus was on gathering and assimilating relevant articles, understanding their relationships and emerging themes, in Stage 2 your focus will be primarily on consolidating all that you have learnt into a coherent, well-structured and critical review of what you have read thus far. 

This is the essence of \textit{synthesis} – the act of bringing ideas together into a cogent whole.
 ...
 Of course, \emph{at this point,} you don't have that much of an actual contribution to knowledge to write about. However, what you \textit{can} start writing about is the literature you have read, and the knowledge gaps that you have found there. 
...
For this you will need further synthesis skills and techniques, which we consider in this section. You should note, however, that while we present them in the context of writing your literature review, these synthesis skills and techniques apply more widely to any form of academic writing, so they will relevant when you write narrative across the whole of your dissertation. 

\subsection{Key skills for synthesising}
...
\begin{itemize}
	\item Paraphrasing. This refers to rephrasing in your own words what an article says, ensuring that the article is appropriately cited. 
...
Both can be used, but an excessive use of quotations may interrupt the flow of your narrative making it harder for the reader. As a rule of thumb, you should use quotations in your literature review if the wording used by the authors of an article you have reviewed really matter, perhaps because they introduce a significant term or concept for the first time or use particularly suggestive language. Otherwise, paraphrasing is recommended and may help you convey the essence of what you have read more concisely or even more clearly. 
...
\subsection{Develop your arguments!}\label{sect:arguments}
...
\subsubsection{Arguments and narrative}
...
%\subsubsection{Organising your arguments}
%
%\textbf{LR-Note: this section is a bit messy at the moment and I'm not sure what should be done with it!}
%
...
\subsection{Developing your literature review from your theme summaries}

If you have made this far, you should now have a collection of summaries based on the themes you have identified from the literature. You will have also revised those summaries to ensure that the academic arguments within are well-formed in relation to the BCW model. Congratulations! You now have some basic building block to put together your very first literature review draft.


\subsubsection{Developing the main body of your literature review}
...
All themes assumes an understanding of what CA are, so that CA definitions should come first. Also, `deriving insights from data' expands on some issues around stakeholders and CA adoption, so it should follow soon after that theme. This led to the following (changes in bold):
\begin{enumerate}
...
Both CA benefits and metrics are quite generic theme, so that they could come early. Re-ordering once more leads to (changes in bold):
\begin{enumerate}
	\item {CA definitions}
	\item \textbf{benefits of CA tools, including capturing student voice}
...
By the end of this process, you should have a structure for our literature review body: each of the themes in your list can be a sub-section which you can populate with the narrative from your summaries. 
...
\begin{guidance} 
You may have to re-apply steps to improve both structure and narrative flow between sections. Structuring a narrative is yet another fundamental skill which becomes easier with practice, so that this is a substantial activity which is likely to require several hours if not days. This is not wasted time as such skills will serve you well in writing up your whole dissertation.
\end{guidance}\end{question}
%%Hack to correct tcbox behaviour
\color{black}
...
\subsubsection{Assessing and iteration, LR}
