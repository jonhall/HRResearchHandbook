...
\begin{table}[htbp]
\small
\caption{Research methods discussed in this book\label{tab:methodsSummary}}
...
\begin{table}[htbp]
\caption{Research strategies discussed in this book\label{tab:strategiesSummary}}
\centering
\small
\begin{ltabulary}{\tablewidth}{@{}LL@{}}
\toprule
 \textbf{Name} & \textbf{Used to:} \\
\midrule
