...
\begin{table}[htbp]
\caption{Stage 2 (15\% of project length) activities\label{tab:stage2}}
\small
\begin{tabulary}{\tablewidth}{@{}LLp{1cm}L@{}} 
\toprule
 \textbf{Research activity} & \textbf{Stage 2} & \textbf{Effort} & \textbf{Suggested focus of your interaction with your supervisor} \\
\midrule
 ...
 \textbf{Setting your aim and objectives} & Adjust, if needed & 2\% & \\
 ...
 \textbf{Reflecting and reporting} & Assess research progress and write up Stage 2 report & 25\% & Any further improvements required, particularly in relation to critical thinking and academic writing \\
 \textbf{Planning work and managing risk} & At stage start, re-assess risk and work plan and adjust as needed If you have received feedback from supervisor on your previous stage work, adjust plan to include any revision recommended & 5\% & Any major adjustment required to address deficiencies or manage risk \\
\bottomrule
\end{tabulary}
\end{table}
...
In Stage 2, you will continue to read and critically summarise the literature, building on your Stage 1 work. At the end of Stage 2, although your literature review won't be in its final form, it will be close to complete – as you work through later stages, you might find a few more papers\footnote{Depending on how thorough you've been, of course.} to consider, but you'll probably be able to count them on one hand.

While in Stage 1 your main focus was on gathering and assimilating relevant articles, understanding their relationships and emerging themes, in Stage 1 your focus was primarily synthesising all that you have learnt into a coherent, well-structured and critical literature review draft. The knowledge, process and techniques you acquired and applied in Stage 1 will still be relevant\footnote{If needed, refresh your understanding by rereading Section~\ref{sect:litrev} in the previous chapter.}, of course, but you will also learnt new tecniques.

\subsection{Synthesis: consolidating what you have learnt; starting to summarise your understanding based on your ongoing reading}

Given the number of articles you'll have to read, and the complexity of the relationships that exist between them, there's a long (and sometimes winding) road from the literature to your dissertation. As explained in Stage 1, You can make best use of the time you spend reading the literature by using the Keshav workflow\footnote{Introduced in Section~\ref{sect:Keshav}.}, iterating quickly between papers, and keeping notes that refine what you have as your understanding develops, and will eventually turn into text you can use for your dissertation, too.
...
However, what you \textit{can} start writing about at this point is the literature you have read, and the knowledge gaps that you have found there. 

\subsection{Creating a narrative for your literature review}
...
\centering
\small
\caption{\todo[inline]{Split A/S up, needs refactoring}Distinguishing between description, analysis, synthesis and evaluation academic writing. (Adapted from \textcite{Cottrell2005}.)\label{tab:synthesis}}
...
You can't make a new contribution to knowledge that someone else has already made – using the work of someone else means the contribution won't be new\footnote{Duh!}.

So, in describing your research, you will have to distinguish it clearly from the work of others.

Part of this is to acknowledge clearly all sources you have used. This is known as attribution and its role is to give credit where credit is due, avoiding any possible accusation of plagiarism, that is passing off the work of others as if it were your own. In a dissertation, the correct form of attribution is through referencing.

Paraphrasing this, you might write
%
\blockquote{\textcite{rapanotti2023masters} suggest being extremely careful in the area of plagiarism}

Another part is the very careful recognition of quotes from others' work. You can do this by proper use of quotation marks to surround quoted text and citations.  To quote that last sentence, you might say:

\blockquote{Another part is the very careful recognition of quotes from others' work. You can do this by proper use of quotation marks to surround quoted text and citations.  \parencite{rapanotti2023masters}}

A third part is to avoid \textit{accidental} plagiarism. While intentional plagiarism is a deliberate attempt to deceive, something that both universities and publishers take very seriously and may have severe consequences, plagiarism doesn't need to be intentional to be classed as plagiarism. Keeping tabs on where ideas/arguments/logic/processes/etc came from, and what your knowledge contribution to those is, is the way to avoid accidental plagiarism\footnote{This very important footnote is to remind me that this was first said in \textcite{rapanotti2023masters}.}.

The final part is to avoid self-plagiarism, which is where you re-use already existing material that you yourself have published without clear attribution\footnote{Clearly, if you haven't published before, unlikely unless you are changing disciplines.}.

If you wanted to reuse the first quote, you'd write 
%
\blockquote{As was reported in \textcite{rapanotti2023masters}, the authors suggest being very careful in avoiding plagiarism.}
...
The development and presentation of academic arguments forms the core of academic writing. But what exactly is an academic argument? 

One useful model is that proposed by Booth, Colomb and Williams in \textcite{Booth1995}\footnote{We will refer to this as the BCW model.}. In the BCW model, an academic argument has at least 2 parts – the \textit{claim} and the \textit{evidence} – and might, in more complex arguments, have up to 3 other parts – called the \textit{reason}, the \textit{warrant} and any \textit{qualifications}. 
...
\caption{The five elements of an academic argument, adapted from Booth et al., 1995. \todo[inline]{LR: Needs redrawing as it is currently a merger from a couple of illustrations in that book - also needs to bring out which parts are mandatory.}
}
%Description
%
...
\begin{example}{The need for a TV `watershed'{\color{green} revisit for sense}}%\todo[inline]{Needs revisiting}}
%
...
It's now time to start developing your arguments. At this point, with all this new stuff around you may be wondering where to start and how to fit them into the BCW model. Try this: 

\begin{question}[subtitle={Activity: Constructing academic arguments}] Consider your current theme analysis table. Consider some key points you wish to include in your literature review, and try to express them following the BCW model.
\todo[inline]{Need to rethink this to allow the student to bring out the component parts of the BCW model and to construct something of that form.}
...
\paragraph{Structure your arguments as narrative!}

Given an argument following the BCW or any other model, the real skill of writing it down is to find a form of narrative that combines all components together in prose that is easily digestible\footnote{Meaning that your reader – cough, examiner, cough – can easily engage with it.}.

The starting point is the following template for creating a narrative around a BCW model argument. The template we will use is adapted from Figure~\ref{fig:argument}.
...
Put the example TV violence argument into the BCW model form.
\begin{solution}
...
Read the result in its raw form – \textbf{as written} – to a willing family member/friend/colleague and ask for their feedback on it. 
\begin{solution}
	Did the template work perfectly? Was your audience engaged or did they fall asleep? Will they come back and help for future versions? 
\end{solution}
\end{question}

\todo{JGH: Link from argument form to lit rev isn't clear to me. Are we saying that the literature review contains all the arguments of the dissertation (``no'') or that arguments throughout the diss should be correctly formatted (yes). In the latter case, why are we using the lit rev as the place to do this?}

\subsection{Organising your narrative}

Look back at the pacman diagram in Stage 1\todo{Introduce this in Stage 1 and explain.}. You should now have most elements that you need to be able to describe the boundary of knowledge in the area of your research problem, including being able to focus  more closely on the knowledge gap you hope to fill. 
...
To do this, your literature review should tell a story to the reader, supported by evidence from previous research and the work of others. Now that you know how a single argument can be structured, you should make a start on creating an overview of the main arguments you wish to make, and get them organised in a logical sequence.
...
\subsection{Developing your literature review in outline}
...
As your literature review grows be prepared to restructure it: into sections and sub-sections, for instance. You might need to go even further\footnote{That the reader can engage easily with your narrative should always your one of your goals.} than sub-sections if you are covering many different topics in great detail, or some related topics should be presented together.
...
\begin{question}[subtitle={Activity: Choosing headings and sub-headings – \todo[inline]{ Still needed?}}] Consider the current draft of your literature review and any further reading you plan to undertake. Consider if breaking it down into sections and sub-sections may help clarity and logical flow, and, in that case, draw a possible table of contents including appropriate headings and sub-headings.

\todo[inline]{Stopped commenting here}
...
\subsection{Assessing your literature review}
Its' worth think about the progress you've made so far. The following activities will help you assess your progress with your literature review and guide any further work required.

\subsubsection{Who can help you assess your progress}

The most important person that can help you is YOU! But there are also people around you that might be able to help. 

The second most important is your supervisor, as an experienced academic writer and topic expert.

Others might be family members/friends/colleague that you can talk to.

Gathering others' feedback will not only help you understand what still needs to be done, but it can also help you to find value in your work so far. Even if you feel the draft is scrappy\footnote{It certainly won't be in its final form as yet.}, for instance, others might be able to bring out things they like about it. 

\subsubsection{Your supervisor's feedback}

\begin{question}[subtitle={ACTIVITY: Sharing your literature review with your supervisor}] Before going further with your literature, it would be wise to ask your supervisor for comments on what you have already achieved. 

Share your current draft with them and ask them to find holes in your arguments. 
...
\item \enquote{AuthorX also made this argument}
...
Carefully gather any and all feedback you receive and follow it carefully to identify and carry out all remaining work to develop a further draft of your literature review.

\begin{guidance}You know what supervisors really like? They like you to take their comments seriously. We don't mean just taking note of what they say and implementing it, but – and this is a good habit to form – writing a response: thank them for each of their comments,  and telling them how the literature review changed because of their input. Your response doesn't have to be long – the shortest response to a comment could be \enquote{Thank you, done!}. Doing this will make them – or anyone that comments – feel really valued. 

At this stage, synthesis, critical reflection and academic writing will be more prominent than searching, reading and assimilating content, so that you will need to pay particular attention at how the structure and narrative of your literature review develops as you incorporate more materials.
...
After that, you will be able to put your literature review aside for Stage 2. You'll come back to it again as your understanding of your research design grows, but that'll be for stage 3. %Conclude your review with a critical summary of the key insights you have gained, which clearly identifies the knowledge gap your project is going to address, so as to justify your research problem, aim and objectives.
\end{guidance}\end{question}
%%Hack to correct tcbox behaviour
\color{black}

\subsubsection{Others' feedback}

Like you did in Activity~\ref{act:???}, read what you have out loud to a live listener and have them try to follow your arguments. Write down their comments as they make them (but trying not to interrupt the flow too much) so 

\begin{question}[subtitle={Activity: A willing audience}]
Read your current draft our to a willing family member/friend/colleague and ask for their feedback on it. 
\begin{guidance}
Did they fall asleep (again)? Will they come back and help for future versions? 
\end{guidance}
\end{question}

\subsubsection{Your role: Assessing scope, planning and iterating}
...
Your literature review has set you on the right course to begin your research – you now know – from your annotations to your pacman diagram – that there's a hole in knowledge into which a contribution to knowledge can be made.

Finding the correct research design will allow you to make that contribution so that:
%
\begin{itemize}
\item the correct techniques, nomenclature, and tools for that domain. 
\item it meets the expectations of the domain's researchers as to how research should be conducted
\item it contributes the right sort of knowledge
\item more here...
\end{itemize}

Of course, the notion of correctness here is a loose one: innovation in research design in a particular domains happens more or less often. Indeed, it is often an innovation in the design of research by which new knowledge is contributed. And it's not unknown for a researcher new to the domain brings fresh thinking – it may even be you. There are risks of innovating, however, including finding it difficult to publish – not a concern for you – having difficulty convincing a reader that's not ready to accept innovation – essentially, being accepted. Risk management is often a Good Thing.
...
They help you conduct your research in a systematic, rigorous, repeatable and reliable fashion. So, research methods are important in research design because they underpin the validity\todo{What do we mean by validity?} of the research you carry out.
...
\paragraph{Charts and graphs} are visual representations of data, usually employed to summarise data, and highlight or identify interesting patterns. All modern spreadsheets provide a wide range of charts and graphs which allow you to visualise data from spreadsheet tables.

\ActivityRMUse{visualisation representations}
...
A \textbf{research strategy}\footnote{Our favourite take on \textit{strategy} is: \enquote{The essence of strategy is choosing what not to do} from the economist \textit{Michael Porter}. Your research strategy should do this – by giving you a focus – so choose carefully, and use the activities wisely.} is a systematisation of a set of research methods, applied in order to address research problems of a particular kind. The term \emph{methodology} is also sometimes used in the literature with a similar meaning, although methodology also means the study of research methods, so it is an overloaded term this handbook will avoid.
...
aims to gain insights which are valid across a target population, by collecting data from a predefined sample in a standardised and systematic way.
...
is used to investigate cause and effect relationships between factors by testing hypothesis or proving\slash disproving causal links.
...
\paragraph{Design science research} seeks to generate new knowledge about a significant problem or its solution via the design of an artefact. It simultaneously generates knowledge about the problem, the artefact and the method used to design it. Artefact indicates anything made by humans, so this is a very broad definition, encompassing all that does not exist in nature.
...
is used to explore complex, messy problematic situations involving multiple and often contrasting perspectives, with the aim of transforming the situation for social betterment.
...
\ActivityRMUse[, and which data collection/analysis/modelling methods you should adopt]{systemic inquiry}

\subsubsection{References}\todo{Here or chapter end? I like it here, so could do both.}
...
\subsection{Sketching your research design}
...
\todo{This move to data/evidence seems a bit abrupt}
...
Table~\ref{tab:remmet} provides a summary of research methods introduced in this section. In the next activity you will reflect on those which are most relevant to your project.

{\begin{table}[htbp]
\small
\caption{Research methods introduced in this section\label{tab:remmet}}
...
\midrule
 ...
 \textbf{Data analysis} & \textbf{Tables and charts} to summarise and visualise data, and identify interesting patterns \\
...
\subsubsection{Research strategies}
Table~\ref{tab:resstrat}\todo{Table needs to break across pages}
 provides a summary of research strategies introduced in this section. In the next activity you will reflect on those which are most relevant to your project.

\begin{table}[htbp]
\caption{Research strategies introduced in this section\label{tab:resstrat}}
\centering
\small
\begin{ltabulary}{\tablewidth}{@{}p{2cm}LLLLLL@{}}
\toprule
...
\todo{They may already have done this}
...
At the end of Stage 2, we recommend you complete a report, extending that of Stage 1, covering the work you have carried out in this stage. As already indicated, writing end-of-stage reports throughout your project will help you consolidate your work, develop your dissertation incrementally, and improve your critical thinking and academic writing skills as you go along.

The recommended structure and content for the Stage 2 report is indicated in Table~\ref{tab:S2report}.

\begin{table}[htbp]
\caption{Report structure and content guidance\label{tab:S2report}}
\centering
\begin{tabulary}{\tablewidth}{@{}LL@{}} \toprule
...
In the next activity, you will use Table~\ref{tab:criteriaStage2} to assess whether your report is of good standard.

\begin{table}[htbp]
\centering
\caption{Criteria to review your report\label{tab:criteriaStage2}}
\small
\begin{tabulary}{\tablewidth}{@{}LL@{}} \toprule
 \textbf{Criteria} & \textbf{Prompts} \\
\midrule
...
%%Repeated section with local differences
\section{Reflection: Stage 2}

After you have filled in your report with as much material as you can, you should review and revise it until you are happy with the story that you are telling about your research, and ready to move on. This may take more than one iteration, but you should ensure you do not delay unnecessarily your work for the follow-up stage.
