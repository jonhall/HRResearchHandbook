...
\section{Writing a full draft of your literature review}\label{sect:stage2literatureReview}
...
\subsection{Understanding research methods and strategies in articles you have reviewed}
...
\section{Reflecting and reporting in Stage 2}
...
In evaluating your report, for each criteria, your should consider the related prompts, write down any further work needed for your next stage, and update your work plan and risk assessment table accordingly.
\end{guidance}\end{question}
%%Hack to correct tcbox behaviour
\color{black}
