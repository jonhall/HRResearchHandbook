...
\item [Methodology] is the system of principles and methods by which you conduct research, that is, investigate phenomena, and gather and analyse data and evidence. Methodology operationalises the \enquote{how} question of knowledge generation, so it is about devising concrete strategies to answer \enquote{How will I make my contribution to knowledge?}. 
\end{description}
