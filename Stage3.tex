...
These are example of, respectively:
	...
	\item Investigator triangulation, in which several researchers are invited to collect and contribute data. Presumably, this also includes some data triangulation as similar data from different locations around the world are collected and analysed.
\end{itemize}
\end{solution}
\end{question}
%%Hack to correct tcbox behaviour
...
Experimental research provides a controlled environment in which cause and effect relationships can be investigated, expressed as hypotheses\footnote{A \gls{hypothesis} is a tentative statement about the relationship between the phenomena to be tested in the experiment.}. The strength of an experiment is that it can reduce the influence of \gls{confounding factors} on a cause-effect relationship, these being some other factors not measured in the experiment that may influence cause and effect.
%From wikipedia:
...
\begin{itemize}
	...
	\item Potential research weaknesses include \gls[validity]{validity bias}, \gls[reliability]{reliability bias}, \gls[novelty]{novelty bias} and \gls{bias weakness}es
