...
\newenvironment{ReportStructureTable}[1]{%
	\setlist{noitemsep,topsep=0pt,partopsep=0pt} %compress list
...
By now you will have some mastery of the techniques and tools that you need to \enquote{do} research at masters level. You may also have ideas about what you still need to do in the next step\footnote{If not, don't worry – we've got you covered with this chapter!}.
