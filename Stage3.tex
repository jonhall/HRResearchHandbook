...
\item can be evaluated by answering a set of evaluative questions.
\end{itemize}

From the first two, you will gain an understanding of which steps you will be required to take to generate, analyse and interpret research data that, when complete, will make your contribution to knowledge. 

The evaluative questions are those that could be asked by a knowledgeable evaluator, such as an examiner: your answers to those questions will help you describe and evaluate your strategy in your dissertation, particularly in relation to potential research weaknesses and how you dealt with them in your project.


\section{The process of choosing your candidate research strategy}

The 12 candidate research strategies we consider are listed in \Cref{tab:ResearchStrategyChoice} and detailed in the following sections. For each, after a brief description explaining the focus of the strategy, we will:

%
\begin{itemize}
\item describe what kind of knowledge contribution that can be made through it, so that you can decide if it is a good fit for your research problem
...
\item describe how a contribution to knowledge using the strategy will be evaluated, with a set of question that you can also use to structure your dissertation narrative
\item ask \enquote{Is this strategy right for me?}, to help you establish how feasible might be for your to adopt the strategy
...
This is a lot to digest! Therefore, rather than going through all the information about each strategy in turn, we recommend you use \Cref{tab:ResearchStrategyChoice} and the following process to first reduce your list of candidate strategies from which to arrive at your chosen one.
...
\begin{itemize}
	...
	\item for each strategy, you should be aware of how it contributes knowledge, which methods are admissible, its potential weaknesses, and where to go in the literature to find out more
	...
	\item in writing up your project methodology you should include your chosen research strategy and methods, which data you will need and where they may come from, and any ethical issues and potential research weaknesses to deal with. These should be complemented by your own reflexive statement and consideration of relevant research mindsets.  
	\end{itemize}
