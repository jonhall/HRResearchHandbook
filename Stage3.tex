\part{The Research}\label{part:research}
...
%\section{Introducing stage 3}\label{sect:IntroducingStage3}
...
With reference to our 5-stage framework, the activities which are in focus in Stage 3 are recalled in~\Cref{tab:stage3acts}, which also provides some guidelines for your interaction with your supervisor during this stage.

%\input{Tables/StageBegin/Stage3}
\input{WritingActivities/Stage3}

%\todo{This is a repeated activity through all stages, and so should be templated.}
\begin{question}[subtitle={Activity: Understanding the effort needed in this stage}] Consider~\Cref{tab:stage3acts} carefully, taking notice of the entries in the `Effort within stage' column. Write down the most time-consuming activities in this stage and what is expected under each.
...
\begin{solution}
We found two potential weaknesses which were considered and addressed in the research:
\begin{itemize}
...
These are example of, respectively:
	...
	\item investigator triangulation, in which several researchers are invited to collect and contribute data. Presumably, this also encompass some data triangulation in the sense that similar data from different locations around the world are collected and analysed.
\end{itemize}
\end{solution}
\end{question}
...
\newcommand{\tick}{$\Box$}
\begin{SimpleFourColTable}[Research strategy choice\label{tab:ResearchStrategyChoice}][X[2]ccX[6]]
	Research Strategy candidate&Considered&Excluded&Reason excluded\\
	Survey&\tick&\tick\\
...
\subsection{Knowledge contribution}\label{ssect:SRKnowledgeContribution}
...
\subsection{Data generation and analysis}\label{ssect:SRDataGenerationAnalysis} 
...
\subsection{Evaluation}\label{ssect:SREvaluation} 
...
The following questions are typically asked of survey research:
	...
	\item Reliability: 
		...
		\item Do they survey questions allow for consistent and dependable measures by different respondents? 
...
\subsection{Is this strategy right for me?}\label{ssect:SRIsThisStrategy}
...
\subsection{Further reading}\label{ssect:SRFurtherReading}	
...
\subsection{Knowledge contribution}\label{ssect:DSRKnowledgeContribution}
...
%\subsection{Focus}\label{ssect:DSRFocus}

%\subsection{Variants}\label{ssect:DSRVariants}

\subsection{Data generation and analysis}\label{ssect:DSRDataGenerationAnd}
...
\subsection{Evaluation}\label{ssect:DSREvaluation}
...
\subsection{Is this strategy right for me?}\label{ssect:DSRIsThisStrategy}
...
\subsection{Further reading}\label{ssect:DSRFurtherReading}
...
\subsection{Knowledge contribution}\label{ssect:ERKnowledgeContribution}
...
%\subsection{Focus}\label{ssect:ERFocus}
%
%\subsection{Variants}\label{ssect:ERVariants}
%
...
\subsection{Data generation and analysis}\label{ssect:ERDataGenerationAnd} 
...
\subsection{Evaluation}\label{ssect:EREvaluation}
...
Typical questions in the evaluation of the experimental research include:
	...
	\item Validity: 
		\begin{itemize}
			...
			\item If a population sample was selected for the experiment, how representative is it? How was it selected? Which measures were taken to avoid sample bias?
...
\subsection{Is this strategy right for me?}\label{ssect:ERIsThisStrategy}
...
\subsection{Knowledge contribution}\label{ssect:KnowledgeContribution}
...
\subsection{Data collection and analysis}\label{ssect:DataCollectionAnd}
...
An experienced researcher evaluating case study research will ask the following questions:
	...
	\item Reliability: 
		\begin{itemize}
			...
			\item Are the procedures followed appropriated documented?
		\end{itemize}
	\item Validity: 
		\begin{itemize}	
...
\subsection{Is this strategy right for me?}\label{ssect:IsThisStrategy}
...
\subsection{Data generation and analysis}\label{ssect:DataGenerationAnd}
...
The evaluation of action research will include the following questions:
	...
	\item Valididty: 
		\begin{itemize}
			...
			\item Were generalisation made and appropriately supported by evidence, including triangulation? 
		\end{itemize}
%	\item Are limitations or omissions in relation to any of the points above identified? Have their effect on the research and its outcomes been discussed?
%
%	\item Has the research strategy been successful in relation to the research aim and objectives?
...
\begin{guidance}
	...
	As you read the literature, you should take notes to augment the summaries we have provided in the previous section, to capture your deeper engagement and growing understanding of each research strategy. By the end of this activity you should have gained a good general understanding of how it may suit your research.

	 In your review, you should pay particular attention to possible data generation and analysis methods under each strategy, reflecting of which may be most applicable to your project and how, alongside any risk or other factors which may affect their successful application. 
...
\begin{SimpleTwoColTable}[How to summarise your research strategy\label{tab:researchStrategyReport}]
	Section & Content \\
Choice and justification & Indicate which strategy, or combination of strategies, you have chosen and justify this choice by considering how it aligns with the aim of your research in relation to the way it contributes\\

Mindset and research paradigm & Discuss how this strategy is consistent with your own mindset, with reference to the research paradigms introduced in this chapter \\
...
\chapter{Managing risk in Stage 3}\label{ch:ManagingRiskIn}

More here

\chapter{Reflecting and Reporting in Stage 3}\label{ch:ReflectingAndReporting}
