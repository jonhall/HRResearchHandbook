\part{The Methodology}\label{part:methodology}
...
\begin{SimpleNColTable}{stage3ResearchActivities}{4}{\RActivitiesTableCaption{3}}[X[4]X[1]X[8]X[8]]
...
%
\begin{itemize}
\item \gloss{Validity weaknesses}, i.e., the claim you have made to new knowledge isn't sufficiently credible, trustworthy, or accurate to be considered knowledge, or can't be generalised or transferred beyond your study

\item \gloss{Reliability weaknesses}, i.e., the steps you have taken to establish your claim of new knowledge are not dependable, cannot be replicated under the same conditions or are not sufficiently repeatable in other contexts, or the descriptions and interpretations you have provided are incoherent or inadequate

\item \gloss{Bias weaknesses}, i.e., the claim you have made to new knowledge has been affected by your implicit or explicit biases, or bias affecting human participants in your study, making the new knowledge invalid

\item \gloss{Novelty weaknesses}, i.e., the hole in the literature that you claimed existed doesn't actually exist.  If there is no hole, then you cannot have contributed new knowledge --- perhaps you missed some key papers in your literature review or, perhaps in the time that you've taken to complete your research, someone else has made a similar contribution to knowledge as that you claim. Alternatively, while a hole may exist, the novelty of your claim may be in doubt --- perhaps your research was not able to achieve all that you were hoping for. 
\end{itemize}
...
\newcommand{\tick}{$\Box$}
\begin{SimpleNColTable}{tab:ResearchStrategyChoice}{4}{Research strategy choice}[X[3]X[1]X[1]X[1]X[6]]
...
Experimental research provides a controlled environment in which cause and effect relationships can be investigated, expressed as hypotheses\footnote{A \gloss{hypothesis} is a tentative statement about the relationship between the phenomena to be tested in the experiment.}. The strength of an experiment is that it can reduce the influence of \gloss{confounding factors} on a cause-effect relationship, these being some other factors not measured in the experiment that may influence cause and effect.
%From wikipedia:
...
Typical questions in the evaluation of experimental research include:
	...
	\item Validity: 
		\begin{itemize}
			...
			\item If a population sample was selected for the experiment, how representative is it? How was it selected? Which measures were taken to avoid sample bias\footnote{\gloss{Sample bias} occurs when some elements of the population are more likely to be selected than others.}?
...
Action research focuses on real-world situations for which improvement is sought through participatory and collaborative research. Its focus is on practice change, and continuous learning and improvement via an iterative \gloss{plan-act-reflect} cycle which generates both knowledge and action: this is an iterative process in which you plan what to do to improve the situation, then enact the plan and reflect on the outcome to inform the next cycle.
...
The evaluation of action research will include the following questions:
	...
	\item Bias: 
		\begin{itemize}
			...
			\item Is there a reflection on self-delusion and groupthink\footnote{\gloss{Groupthink} is a tendency to conform to majority option to maintain unanimity and avoid confrontation.}? How were these mitigated? Was the mitigation successful? If not, what was the outcome?
		\end{itemize}	
	\item Valididty: 
		\begin{itemize}
...
The type of analysis you will conduct will depend on the nature of the evidence you are considering and combining. A \gloss{narrative review} produces a narrative synthesis of qualitative results, while \gloss{meta-analysis} uses statistical techniques to analyse and combine quantitative results. Combinations of the two are also possible. 
...
\begin{enumerate}
\item Grounded theory is about letting the “data to do the talking” \cite{drew202310-grounded}, so you should not have any prior belief, theory or hypothesis you wish to put to test. If that's not the case, other strategies are more appropriate, like case studies or experiments
...
\ReadingExtras{grounded theory}{{drew202310-grounded}{smith1997understanding}{corbin1990grounded}{strauss1998basics}{gibson2013rediscovering}{charmaz2014constructing}}
...
\ReadingExtras{phenomenology}{{merleau1956phenomenology}{anderson1991qualitative}{smith2018phenomenology}{shudak2018phenomenology}{academic-educational-materials2019understanding}{office2020the-phenomenological}{groenewald2004a-phenomenological}{hycner1985some}}
...
In this strategy, it does not make sense to talk about data generation and analysis. Instead, we refer to  kinds of reasoning. These may include: \gloss{deductive reasoning}, which starts from (true) assumptions and arrives at the proposition as a conclusion; \gloss{inductive reasoning}, which draws general conclusions from particular observations; and \gloss{proof by contradiction}, which arrives at a contradiction by assuming the proposition to be false, hence demonstrating that it must be true.
...
The mixed methods research strategy\footnote{Mixed-method research should not be confused with \gloss{multi-method research}, which simply indicates the use of many methods, possibly all qualitative or quantitative.} combines elements of both qualitative and quantitative research, with the aim to increase both breadth and depth of understanding of the phenomenon under study, and corroboration of results, giving more confidence in the conclusions reached. As a result, triangulation is in-built within the strategy.
...
\begin{guidance}
	...
	As you read the literature, you should take notes to augment the summaries we have provided in the previous sections, to capture your deeper engagement and growing understanding of each research strategy. By the end of this activity you should have gained a good general understanding of how each strategy you have reviewed may suit your research.
	 ...
	 In your review, you should pay particular attention to possible data generation and analysis methods under each strategy, reflecting on those which may be most applicable to your project and how, alongside any risk or other factors which may affect their successful application. 
...
\begin{SimpleNColTable}{tab:researchMethodologyReport}{2}{Elements to include in your research methodology account}[X[2]X[6]]
Section & Content \\
...
Methods & Indicate the selection of methods you intend to apply within your research strategy, including possible generation, modelling and analysis methods. Explain why they are consistent with your choice of research strategy, and suitable and feasible for your own project\\
...
\begin{SimpleNColTable}{tab:criteriaForReport3}{2}{Criteria for reviewing your report}[X[2]X[6]]
Criteria & Prompts \\
...
\begin{itemize}
	...
	\item Potential research weaknesses include validity, reliability, novelty and bias weaknesses
