...
Simulations are pervasive across disciplines and vary greatly in their purpose, nature and design. For instance: financial simulations are used to study the behaviour of the global stock market; climate simulations to study possible effects of climate change; engineering simulations, to test the properties of materials under different stress conditions; social simulations to study to study human behaviour in social settings, to name just few examples.  
...
Data are needed to inform the simulation design. Their kind and how to obtain it will depend strongly on the nature of the artefact or system under study and what your research aim is, so that all known methods for data generation apply. For instance, if you'd like to simulate a new aircraft design under different wind conditions, you will need to gather data on the physical characteristics of the aircraft and the materials to be used to build it, alongside meteorological data which can be used to perform tests under different conditions in the simulation. On the other hand, to simulate how size and age of a population may change in future decades within a particular geographical region, you will need to gather data on current population size and age, birth and mortality rates, migration rates in and out of the region, and conditions which may affect them over time. 
...
\begin{enumerate}
	...
	\item Were appropriate data gather to inform the simulation design? How were they chosen and why?
	...
	\item How close are the simulation's outputs or behaviours to the real-world data? Do the results make sense?
\end{enumerate}
...
\begin{enumerate}
	\item Do I already have the computing/mathematical/statistical skills that I need to undertake the research?
	\item Do I have access to the data needed for the design and the evaluation of the simulation?
\end{enumerate}
