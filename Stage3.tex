...
With reference to our 5-stage framework, the activities which are in focus in Stage 3 are recalled in Cref{stage3ResearchActivities}, which also provides some guidelines for your interaction with your supervisor during this stage.

\subsection{Your Research Activities for this stage}

\todo{More here}

\begin{SimpleNColTable}{stage3ResearchActivities}{3}{\RActivitiesTableCaption{3}}[X[1]X[2]X[2]]
...
\begin{question}[subtitle={Activity: Understanding the effort needed in this stage}] Consider Cref{stage3ResearchActivities} carefully, taking notice of the entries in the `Effort within stage' column. Write down the most time-consuming activities in this stage and what is expected under each.
