...
%
\begin{description}
\item [Ontology] is the study of the nature of existence\footnote{If you're interested, there's a fuller discussion of \emph{Ontology} in the Stanford Encyclopedia of Philosophy \parencite{hofweber2023logic}.} and addresses the question: \enquote{What is the reality that I will research?}. Practically, ontology is about finding out what you aim to examine which, in its simplest form, reduces to determining what \emph{phenomena} exist in the context of the your research, the \emph{relations} that exist between them and how they group together into \textit{categories}.

\item [Epistemology] is the study of knowledge\footnote{If you're interested, there's a fuller discussion of \emph{Epistemology} in the Stanford Encyclopedia of Philosophy \parencite{steup2020epistemology}.} and addresses the question: \enquote{How will I generate the knowledge and from what sources?}. Practically, epistemology is about finding out \enquote{What people know?}, \enquote{What does it mean to say that people know something?}, and \enquote{How do people know that they know?}.

\item [Methodology] which is the system of principles and methods\footnote{Even if you are interested, there is (at the time of writing) no Stanford Encyclopedia entry for methodology, unfortunately. But, unlike ontology and epistemology, we go into more detail of methodology below.} by which you choose to investigate, measure, and analyse your research’s aim and objectives. Methodology answers the \enquote{how} question, \enquote{How will I make my contribution to knowledge?}.
\end{description}
...
Researchers in different communities and disciplines have developed differing mindsets over time, which are known in the literature as research paradigms\todo{[ADAPTED from https://proofed.com/writing-tips/the-four-types-of-research-paradigms-a-comprehensive-guide/]} or philosophical traditions:

\begin{description}%[start=0,label={(\bfseries R\arabic*):}]
\item [The Positivist Research Paradigm] which assumes that there is a single, objective reality that can be accurately known, described and explained. Positivist researchers depend on observations of this reality to gain knowledge of it.
...
The positivist research paradigm is mostly used in situations where an \enquote{single objective reality} is most expected, i.e., the natural sciences, the physical sciences, or whenever very large sample sizes can be used. It leads the researcher to quantitative analysis of objective measurements and formal simulations, including techniques from mathematics, statistics, and computational thinking.
...
The term \enquote{positivism} is suggestive of reinforcement through confirmation: we do experiments which reinforce known true knowledge. 

%You might have this mindset if you don't question received truth.
...
\textit{I'd know precisely how to check whether \enquote{That cat is blue} is true or false.}
...
. If not a complete rethink, then Einstein's work inspired a substantial move away from the established \enquote{laws} and \enquote{facts}, which were neither any longer. \textcite{laka}
