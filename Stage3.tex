...
Evaluation of the systematic research review will involve answers to the following:
	...
	\begin{enumerate}
	\item Are the criteria they have used to select, evaluate and combine the published research explicit and reproducible? Were there any deviations from this protocol and, if so, are they explained, justified and documented?
	...
	\item If narrative reviews, to which extent potential bias has been acknowledged and mitigation measures applied?
...
Here are success criteria for this strategy:
...
For example, grounded theory could be used to formulate theories on what motivates people to join or leave a particular organisation, or why they may feel fulfilled or frustrated in their workplace.  
...
Grounded theory requires the systematic collection and analysis of data without assuming any preconceived belief or theoretical framework. The data are collected, coded and analysed to define emerging concepts, categories and relationships. The process is iterated with new data used to review and revise those concepts, categories and relationships until no more can be gained from further data collection. In this process, it is essential to be open open to multiple explanations, and exploring the data from all angles in order to gain a fresh perspective.
...
\begin{enumerate}
	...
	\item Which concepts, categories and relationships were generated by the research? How are they grounded in the data?
\end{enumerate}
