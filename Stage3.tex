...
Apropos Newton's Laws, with so much invested in them, you might see that Einstein's insight into the intimate connection between space and time could lead to something of a crisis in the Positivist movement~(see, for instance, \textcite{lakatos2014falsification})%, with \textcite{kuhn2012structure}
...
\item a number of references that you give more detail if you are seriosly considering the strategy.
\end{itemize}
%
...
\begin{tblr}{rcc}
	\textbf{Research Strategy candidate}&\textbf{Considered}&\textbf{Excluded}\\
	Survey&\tick&\tick\\
	Design and Creation&\tick&\tick\\
	Experimental&\tick&\tick\\
	Case study&\tick&\tick\\
...
\begin{MoreDetails}\footnote{Add annotations to cites.}
...
\resourcelistcite{dillman2014internet,
...
\begin{MoreDetails}
\resourcelistcite{oates2008researching,brocke2020introduction}
\end{MoreDetails}
