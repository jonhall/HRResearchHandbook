...
The 12 candidate research strategies we consider are listed in Cref{tab:ResearchStrategyChoice}. For each, after a brief description explaining the focus of the strategy, we will:
...
\begin{SimpleNColTable}{tab:ResearchStrategyChoice}{4}{Research strategy choice}[X[3]X[1]X[1]X[1]X[6]]
	...
	Design Science&\ref{sect:DesignScienceResearch}&\tick&\tick\\
	Experiment&\ref{sect:ExperimentalResearch}&\tick&\tick\\
	...
	Systematic research&\ref{sect:SystematicResearchReviews}&\tick&\tick\\
...
Copy Cref{tab:ResearchStrategyChoice}	to your favourite word processor or spreadsheet application. Apply the process above until you have considered all the strategies, updating your table as you go along, and recording related references in your bibliographical database. 
\begin{guidance}
...
\section{Systematic research reviews}\label{sect:SystematicResearchReviews}
...
In a systematic research review you only use evidence from published studies and rely on explicit, reproducible methods to identify the relevant research to review. Specifically, you must decide upfront your research problem/question and the set of criteria you will use to select, compare and evaluate those studies, and combine their results. 
