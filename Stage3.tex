...
\begin{SimpleThreeColTable}[\RActivitiesTableCaption{3}\label{stage3ResearchActivities}][X[1]X[2]X[2]]
...
Setting research aim and objectives&Finalise aim and objectives, and define tasks and deliverables&Suitability of tasks and deliverables from objectives\\
Developing the research design&{Complete research design, with detailed consideration of data and evidence, research strategy, research methods and procedures}&Suitability of research procedures\\
Gathering and analysing evidence&Conduct pilot work to test aspects of your research design&Scope of your pilot work\\
Interpreting and evaluating findings&n/a&\\
Reporting&Write up Stage 3 report&Any further improvements required\\
...
Planning work&At stage start, plan Stage 3 work in detail, including any revision or additional work needed from the previous stage.&Any major adjustment required\\
...
\newcommand{\tick}{$\Box$}
\begin{SimpleFourColTable}[Research strategy choice\label{tab:ResearchStrategyChoice}][X[3]X[1]X[1]X[1]X[6]]
...
\subsection{Data generation and analysis}\label{ssect:DesignScienceResearchDataGenerationAnd}
...
\subsection{Data generation and analysis}\label{ssect:ExperimentalResearchDataGenerationAnd} 
...
\subsection{Data generation and analysis}\label{ssect:ActionResearchDataGenerationAnd}
...
\subsection{Data generation and analysis}\label{ssect:EthnographyDataGenerationAnd}
...
\subsection{Data collection and analysis}\label{ssect:SystematicResearchReviewsDataCollectionAnd}
...
\subsection{Data collection and analysis}\label{ssect:GroundedTheoryDataCollectionAnd}
...
\subsection{Data generation and analysis}\label{ssect:PhenomenologyDataGenerationAnd}
...
\subsection{Data generation and analysis}\label{ssect:SimulationDataGenerationAnd}
...
\subsection{Data generation and analysis}\label{ssect:MathematicalAndLogicalDataGenerationAnd}
...
%
\subsection{Data generation and analysis}\label{ssect:MixedMethodsResearchDataGenerationAnd}
