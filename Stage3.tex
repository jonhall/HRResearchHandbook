...
\subsection{Researcher mindset: a brief introduction}
...
\centering{
  ...
  \caption[A complex research strategy for education research]{A complex and complete model of education research~\parencite[, Figure 1]{andrews2005place}
  \label{fig:andrews1}
  	}  
  }
\end{figure}
...
First, we'll do a mini skills\footnote{Another word is: } assessment. Then we'll look at the evaluative drivers of research. Given the outcomes of these, you'll craft a method from research tasks.
...
If the outcome of reading the previous section is that you think that surgery research is suitable, you might like to look into the following articles that go into more detail, either in a general setting, or in specific areas.
...
\textcite[p.151, adapted]{oates2008researching}%
	...
	\item Does the research look at dynamic relationships between phenomena and the processes in which they participate?
	
	\item What generalisation were able to be made from the case study research? Are the generalisations appropriate for the phenomena and its context?
	
	\item What use of theory of the phenomenon is made in the case study?
...
From the evaluation, you'll see that an experienced case study researcher will be looking for rich, detailed descriptions of the phenomena and its relationships. Case study research therefore requires you to have access the a phenomena at an intensity at which such richness and detail are perceived. As an example, if you're not a teacher, it might be difficult to gain access to a classroom to study student/teacher interactions. Should you not have appropriate access, then another research strategy would be a better choice, including systematic research reviews through the literature.
