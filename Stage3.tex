...
\subsubsection{Data generation and analysis} 
...
~\parencite[p.105 (adapted)]{oates2008researching}:
	...
	\item Has the research strategy been successful in relation to the research aim and objectives?	\end{enumerate}
...
Data analysis focuses on knowledge generated in the evaluation of both problem and artefact, including solution characteristics in relation to the extent they address the problem -- the identified need in context. Specific evaluation techniques will depend on the nature of the artefact, and may include problem owner\footnote{By problem owner we mean the person or people who have expressed the need to be addressed and are able to establish whether the solution has met it.}'s validation, and various forms of testing, or end-users' evaluation and feedback.
...
\begin{enumerate}%[start=0,label={(\bfseries R\arabic*):}]
	...
	\item How is the artefact assessed? Are the assessment criteria documented? Are the criteria appropriate? How were they determined?
...
\todo{add references from DSR literature}	
...
Experimental research provides a controlled environment in which cause and effect relationships can be investigated, expressed as a hypothesis\footnote{A hypothesis is a tentative statement about the relationship between the phenomena to be tested in the experiment.}. The strength of an experiment is that it can reduce the influence of confounding factors on a cause-effect relationship. 
%From wikipedia:
...
Evaluation of the experimental research strategy typically consists of the following questions \parencite[p.138, adapted]{oates2008researching}%
	...
	\item Are the experimental variables manipulated or measured adequately described? What additional information is given?
	...
	\item If a population sample was selected for the experiment, how representative is it? How was it selected?
	...
	\item If statistical analysis is applied, is it adequate? Have appropriate statistical tools been used and their use justified?
	\item Are limitations or omissions in relation to any of the points above identified? Have their effect on the research and its outcomes been discussed?
	\item Has the research strategy been successful in relation to the research aim and objectives?
	\end{enumerate}
...
%
	\begin{enumerate}
	\item your research must be concerned with cause-and-effect relationships, for which it is possible to formulate hypotheses that can be tested
...
What you seek with a case study spans from exploring possible questions or hypotheses for follow-up research, to explaining why certain outcomes have occurred, to investigate changes over time. Therefore, case studies come in many forms, including:
...
An experienced researcher evaluating case study research will ask the following questions:
	...
	\item Which data generation methods were used? Did they generate the right type of data about the phenomenon in sufficient depth and quantity?
...
yin2009case, oates2008researching
...
Action research should make both a contribution to knowledge \textit{and} to practice: an action researcher strives to generate knowledge and action to address important problems that people experience in their practices, so that the knowledge contributed originates in real-world needs. The researcher is an active participant in the research, rather than solely an observer, alongside other collaborating practitioners: in fact, collaboration, alongside reflection, is a key element of this strategy.
...
\parencite[p.169, adapted]{oates2008researching}%
	...
	\item Have the researcher's personal stake and potential biases been discussed?
	
	\item Is there a reflection on self-delusion and group-think of the collaborators? How was this mitigated? Was the mitigation successful? If not, what was the outcome?

	\item Has the research generated both knowledge and action leading to change? Are any claims made appropriate for action research context?
		
	\item What data generation methods were used? Were they appropriate, and was enough data collected?
...
oates2008researching,johannesson2014research
...
An experienced researcher evaluating ethnography will ask the following questions:

	\begin{enumerate}
	\item Is the cultural characterisation obtained sufficiently rich to account adequately the group's beliefs, customs, behaviours and interpersonal relations?
...
There are conditions for this strategy to be successful:
	...
	\item In ethnographic research you allow the culture under study to determine the outcomes of the research, so you should approach it without any preconception or bias. If there is any possibility that you could be biased to a particular outcome – as might happen if you feel you already know the outcome and are simply trying to confirm this – then ethnography is unlikely to lead to a successful outcome for your research. Any competent ethnographer will be particularly sensitive to expressions of bias, even if they aren't even intentional. Indeed, such bias may preclude any successful research strategy being applied.
...
In a systematic research review you only use evidence from published studies and rely on explicit, reproducible methods for identifying the relevant research to review. Specifically, you must decide upfront your research problem\slash question and the set of criteria you will use to select, compare and evaluate those studies, and combine their results. 
...
Evaluation of the systematic research review will involve answers to the following:
	...
	\begin{enumerate}
	\item Are the criteria used to select, evaluate and combine the published research explicit and reproducible? Were there any deviations from this protocol and, if so, are they explained, justified and documented?
...
wright2007write,moher2009preferred,pollock2018systematic
...
smith1997understanding,drew202310-grounded,corbin1990grounded,strauss1998basics,gibson2013rediscovering,charmaz2014constructing
...
\begin{enumerate}
	\item Is the phenomena accurately and objectively described?  Is the account provided one that can be recognised by anyone who has experienced that phenomenon?
...
Data are needed to inform the simulation design. Their kind and how to obtain it will depend strongly on the nature of the artefact or system under study and what your research aim is, so that all known methods for data generation apply. For instance, to simulate a new aircraft design under different wind conditions, you may need to gather data on the physical characteristics of the aircraft and the materials to be used to build it, alongside meteorological data which can be used to perform tests within the simulation under different conditions. On the other hand, to simulate how size and age of a population may change in future decades within a particular geographical region, you may need to gather data on current population size and age, birth and mortality rates, migration rates in and out of the region, and conditions which may affect them over time. 
...
Evaluation questions specific to this strategy:
...
\begin{enumerate}
	...
	\item How was the simulation constructed? Were the appropriate computational/mathematical/statistical techniques applied?
	\item How was the simulation tested and improved during its development?
...
Is you are considering the simulation research strategy, then you should consider the following questions:
\begin{enumerate}
...
A new proof is subject to the scrutiny of the community of mathematicians, which employs various means to check both assumptions and reasoning, so as to reach a verdict on the validity of the proof. Such means may include using alternative deductive reasoning to check they can reach the same conclusion, including using examples in support of the reasoning, or even recreating a mathematical proof within a fully formal system or using computer-based automated checker, when applicable. 
...
\RSActivity{mathematical and logical proof}{Kleene1964introduction,lakatos2015proofs,antonini2011examples,johannesson2014research}
...
\begin{itemize}
	\item parallel, in which separate qualitative and quantitative methods are applied to gather different sets of data. For instance, your collection of pedestrians' accident data, and pedestrian's opinions may occur in parallel, independently of one another, then the results may be compared and analysed.
...
Evaluation question for this strategy include:

\begin{enumerate}
		\item How was the use of mixed methods justified in relation to the phenomena of interest?
		\item Is the way the methods are combined appropriately described?
		\item How has the study benefitted from their combination?
...
\RSActivity{Mixed methods research}{johnson2007toward,denzin1978research,webb2000unobtrusive}
