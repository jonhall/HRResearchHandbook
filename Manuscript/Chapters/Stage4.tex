...
\begin{activity}[{Deep reading on sampling}]
...
\begin{activity}[{Managing your raw data}]
...
\ReadingList{observations}{daston2011introduction,marvasti2014analysing,simpson2003using,driscoll2011introduction,angrosino2003observations,sapsford1996data}
...
\ReadingList{questionnaires}{oates2008researching,hays2003case,burns2009action,mcclure2002common,najafi2016observation,robertson2002automated,kielmann2012introduction}
...
\ReadingList{interviews}{oates2008researching,johannesson2014research,secor2010social,hays2003case,mcclure2002common,peoples2020write,jorgensen2001grounded,hycner1985some,englander2012interview,ramsook2018methodological,robertson2002automated,kielmann2012introduction}
...
\ReadingList{focus groups}{powell1996focus,smithson2000using,plummer-damato2008focus}
...
\begin{activity}[{Visualisation techniques for {qualitative-datum}}] 
...
\subsection{Inferential statistics applied to your data}\label{ssect:yourInferentialStatistics}

It's time to apply \glsf{inferential-statistics} in your project.

\begin{activity}[{Applying inferential statistics to your data}] 
...
\begin{takeaways}{Stage IV}\label{ch:Stage4Takeaways}
