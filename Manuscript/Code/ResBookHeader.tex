...
% Dots between title and page – memoir *does* provide \cftdotsep
...
% #1 = filename, #2 = width (e.g. 18mm), #3 = inset from right, #4 = inset from bottom
\newcommand{\AddCornerLogoToAllPages}[4]{%
  \AddToShipoutPictureBG{%
    \AtPageLowerLeft{%
      \raisebox{#4}{%
        \hspace*{\dimexpr\paperwidth-#3\relax}%
        \makebox[0pt][r]{\includegraphics[width=#2]{#1}}%
      }%
    }%
  }%
}
