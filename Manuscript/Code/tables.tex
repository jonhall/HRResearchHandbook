...
\newcommand{\narrowtablewidth}	{\linewidth}
\newcommand{\widetablewidth}	{1.3\linewidth}

\newcommand\zapgls{%
	\renewcommand\glsf{\glsentryname}%
	\renewcommand\glsplf{\glsentryplural}%
	\renewcommand\Glsf{\Glsentryname}%
	\renewcommand\Glsplf{\Glsentryplural}%
}
...
\NewDocumentEnvironment{SimpleNColTable}{
		...
		\begin{tblr}{
				...
				rows 		= {m},
				rowhead 	= 1,
				column{1} 	= {2-Z}{cmd=\zapgls},
		  		hline{1,2,Z}= {fg = \frameColor, wd=2pt},
				vline{1,2,Z}= {fg = \frameColor, wd=2pt},
