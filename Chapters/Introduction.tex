...
The LyX tool \footnote{LyX is available at \url{lyx.org}.} provides a Word-like interface for \LaTeX{} which can reduce the initial learning curve. If you find it easier to use a Word-like interface, but want the benefits of \LaTeX{}, you might like to try it.
\end{solution}\end{question}
%%Hack to correct tcbox behaviour
\color{black}
