...
\begin{question}[subtitle={Activity: Investigating \LaTeX{} tools}] \LaTeX{} is a mature system and numerous tools are now available, from open source to proprietary, from desktop to web-based. 
