...
Our framework therefore emphasises both reflection and reflexivity as essential activities within the research process, to develop and consolidate the knowledge and skills you need to be a competent and confident researcher, and to guard against \gls{bias}.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{Figures/slugDiagram.jpg}
...
For your initial project plan you will focus on your overall project timeline, and how to arrange stages and main activities along it. You should also treat reaching the end of each stage as a \gls{milestone}. In the following chapters, we will detail stage by stage the work you will be expected to complete under each activity, so that you will be able to identify tasks, \glspl{milestone} and \glspl{deliverable} more precisely and refine your plan accordingly. 
...
Following from the previous example, \Cref{t:allStagesActivities} can be used to calculate the project time per activity across all stages. The easiest way to do this is to enter the table in a spreadsheet, which resulted in~\Cref{t:allStagesActivitiesExample}. The calculations are in hours and based on 600 hours for the overall project. To calculate the time of each activity within a stage, we first calculated the time for the stage overall, say 90 hours for~\Cref{stage1}, then the time of each activity by applying the recommended percentage, say 20\% of 90 for identifying the research problem in~\Cref{stage1}, corresponding to 18 hours.
\end{example}
