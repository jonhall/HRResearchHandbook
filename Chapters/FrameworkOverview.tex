...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{Figures/researchActivities.jpeg}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{Figures/slugDiagram.jpeg}
...
Research activity&{\Cref{stage1}\\ (15\%)}&{\Cref{stage2}\\ (15\%)}&{\Cref{stage3}\\ (20\%)}&{\Cref{stage4}\\ (20\%)}&{\Cref{stage5}\\ (30\%)}\\
...
Research activity&{\Cref{stage1}\\ (15\%)}&Hours &{\Cref{stage2}\\ (15\%)}&Hours &{\Cref{stage3}\\ (20\%)}&Hours &{\Cref{stage4}\\ (20\%)}&Hours &{\Cref{stage5}\\ (30\%)}&Hours \\
...
\paragraph{Investing in the right tools for the job} While you may find it a nuisance to have to spend time learning new tools, such as a BMT\todo{Is this defined?} or some advanced word processing features, doing so will save you time in the long run, so make sure you invest in setting up your new systems and learning new skills earlier on in your project.
