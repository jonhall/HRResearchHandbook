...
\Cref{tab:contentBreakdown} gives an example based on the dissertation structure of~\Cref{dissertationTemplate}. It uses guidelines from the Open University for Masters level research dissertations in STEM\footnote{STEM stands for Science, Technology, Engineering and Mathematics.} taught programmes, where dissertations are usually between 10,000 and 15,000 words in length. Of course, these are only guidelines and need not be applied too rigidly: you can used them as a baseline, then adapt them to the needs of your project.
