...
\MRpart{The Literature}{part:Lit}{The focus of Stage 2 is on completing your literature review and developing your understanding of research design.}
...
The need to rethink positivist objective truths was something of a crisis in the positivist movement~(see, for instance, \textcite{kuhn2012structure}), leading to \gls{post-positivism}\footnote{Not the most creative name, you must admit.} which introduced the idea of \gls{falsification}: any posited theory must make predictions which are testable, the currency of a theory being determined by whether or not it had yet been proven false\footnote{Note that falsifiable theories that have been tested and failed can still be useful, perhaps within a restricted context. For instance, Newton's Laws of motion provide a very good approximation at low energies.}. 
