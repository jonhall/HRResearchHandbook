...
\begin{activity}[{Looking up your University's \glsf{plagiarism} policy}] Look up your university policy on \glsf{plagiarism} and any disciplinary processes related to it.
...
\begin{activity}[{Differentiating between \glsf{reason} and \glsf{evidence}}] Consider the example above and write down what you think the difference between \glsf{reason} and \glsf{evidence} is.
