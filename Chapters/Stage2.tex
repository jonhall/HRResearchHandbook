...
\Gls{positivism} assumes that there is a single, objective reality that can be accurately known, described and explained. It contributes knowledge as explanations of this reality, constructed from \glspl{hypothesis} which are confirmed through observations and measurements, hence becoming universal laws or facts.
...
In moving away from objective knowledge, however, \gls{anti-positivism} raises questions of research \gls{validity}\footnote{You will encounter \gls{validity} in~\Cref{ch:DefendingYourClaim}.}, that is of how trustworthy and generalisable knowledge generated as subjective interpretation might be. 
