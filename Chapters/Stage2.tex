...
Here we introduce \glsdupe{generation-method}{generation-}, \glsdupe{modelling-method}{modelling-} and \glspl{analysis-method} in\Cref{tab:generationMethods,tab:modellingMethods,tab:analysisMethods}. Briefly:
%
\begin{itemize}
