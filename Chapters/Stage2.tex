...
Looking at the table, reviewing in the literature is the most demanding activity, at 30\% of the overall stage effort: in this stage you will complete your first full literature review draft, building upon your groundwork from~\Cref{stage1}. As a result, you may have to adjust or refine your research scope, including research problem, aim and objectives.
...
All other research activities are similar in effort to~\Cref{stage1}. You should ensure you complete each of them, even if they are not covered explicitly in this stage. In particular, you should engage in reflection and reflexivity as you go along, and revisit your risk assessment to ensure all major risk is accounted for.
...
Reflection and reflexivity &10\% & Apply to~\Cref{stage2} work and experience as you go along &\\
...
This is a good point to refine your project work plan to include more detail on your work for~\Cref{stage2}. 
...
You must be able to draw links between the articles that you have found, a process you started in~\Cref{stage1} by constructing a summary-comparison matrix\footnote{Refer back to~\Cref{sect:stage1LiteratureReview} if necessary.} and identifying emerging themes.
...
\item States what a theory says 
\item Lists things, alternatives and options,~\etc{}.
\item Describes a system or its components
\end{itemize}
} \\
Analytic & {\begin{itemize}
\item Explains why things happen
\item Explain why things work the way they do 
\item Shows relations between pieces of information, parts of a system
\item Demonstrates how a theory works
\end{itemize}
}\\
...
\begin{itemize}
	\item \Gls{circular-reasoning}\footnote{AKA begging the question or begging the claim.}, in which the supporting evidence is just a restating of the claim. As a result the claim is not supported by evidence at all
	...
	\item \Gls{post-hoc-ergo-propter-hoc} ––– \enquote{after, therefore because of}%%JW375
	 ––– which claims a causal relation between two phenomena because one happens after the other. Only because two things happen one after the other does not necessarily mean that the first causes the second: it may be random chance, or there may be other factors which cause or influence both.
	\item \Gls{false-dichotomy}\footnote{AKA black and white fallacy or false dilemma.}, in which an \emph{either--or} claim is made which assumes that there are two mutually exclusive phenomena where that's not the case --- the phenomena may not be mutually exclusive at all. 
\end{itemize}
...
Fortunately, many scholars have thought very deeply about ontology and epistemology\footnote{For instance, if you're interested, you can find a fuller discussion of {ontology} and epistemology in the Stanford Encyclopedia of Philosophy.} and, in most areas and for the vast majority of master's or doctoral level research, their thinking will suffice. If not, you'd be left in a situation in which even an ostensibly simply statement like \enquote{That hat is blue} becomes in need of complex debate \parencite[Section 4.1]{steup2020epistemology}.
...
Ethnography & in-situ, participatory study of practices, meanings and interactions, reported as rich (or \enquote{thick}) description\\
...
%
%For this reason, in~\Cref{stage1}, we will not consider research design in detail --- that will happen from~\Cref{stage2} instead. However, so that you can start to think about your research design, in this section, we introduce a range of topics which concern research design and should influence your follow-up work.
%
...
%
%As per advanced statistical analysis, statistical modelling requires well developed statistical knowledge and skills, which you should already possess, or have the time to develop, if you are considering their use in your master's project.
%
...
%
%\item Research is based on the empirical testing of theories or hypothesis, leading to either confirmation or rejection (AKA \enquote{refutation}). As there can only be one truth, either the theory or hypothesis tested is that truth, in which case all subsequent tests will confirm it, or it is not that truth, in which case at some point a test will reject it. The term refutation is used to indicate that a truth, albeit universal, is always tentative: it will be valid until somebody comes up with a test to reject it.
%
...
% Cref{tab:dataevidence} provides a summary of the type of data and evidence that were introduced in~\Cref{stage1}. In the next activity you will reflect on those which are most relevant to your project.
%
%\begin{table}[htbp]
...
\printbibliography[segment=\therefsegment,title=\Cref{stage2} \bibname]