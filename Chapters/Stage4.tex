...
%%\end{figure}
%
\begin{SimpleNColTable}{tab:exampledata set}{7}[\narrowtablewidth]{Example: the US housing market}[X[-1,r]X[-1,c]X[-1,c]X[-1,c]X[-1,c]X[-1,c]X[-1,c]]
...
\begin{SimpleNColTable}{tab:pivot1}{5}[\narrowtablewidth]{Pivot table of average property prices by neighbourhood and number of bedrooms}[X[-1,r]X[c]X[c]X[c]X[c]][row{2,Z} = {bg=\frameColor,fg=white,font=\bfseries}]
