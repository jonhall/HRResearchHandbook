...
\begin{SimpleNColTable}{tab:testsForAssociation}{6}{Common statistical tests for \gls{association}. \textit{Parametric} tests apply to normally distributed data; \textit{non parametric} tests to skewed distributions}[R[4]X[-1]R[4]R[2]R[2]R[4]]
Purpose & Variables & Example & Parametric & Non parametric & Notes  \\
