...
Below is the Research Activity table for Stage 1. Looking at the table, of the activities covered in this stage, reviewing in the literature is the most demanding at 30\% of overall effort for this stage, closely followed by identifying the research problem at 20\%: together, they are your first steps to understanding what your project's contribution to knowledge might be and so it is good to invest a lot of time in these. Setting aim and objectives (5\%) and starting to develop your understanding of research design (10\%) follow from them.
...
Developing the research design&5\%&{Consider ethical issues and regulations relevant your research.}&{Compliance with own university’s ethical and legal guidelines}\\
...
In addition, consider possible milestones agrees with your supervisor, for instance, specific points when to review your progress together, and add them to your plan.
\begin{guidance}
...
A deep-seated interest in a question\footnote{Great research often arises from the researcher's passion for the topic.} will help you keep interested. However, even a passionate interest can only take you so far: you should also avoid topics in which you have little existing knowledge, for instance, or that will require you to learn and master major new skills. This is particularly through of capstone Masters projects, whose timescale is relatively short\footnote{If you are doing one such project, you will be already very busy without having to learn completely new subject areas or master completely new skills.}.
...
\item J: {\ldots}what's the Justification?
...
If the scope was the UK, then there would be crazily many phenomena that Anna could think about: choosing the UK is just too large. The UK higher eduction sector is beginning to be a more realistic scope, but there are other choices that make even more sense. Anna aims to investigate project estimates and forecasting in their university, so that the PMO is the most suitable context for thei research, particularly if it shares similarities with other PMOs across the sector.
...
\begin{SimpleNColTable}{tab:descriptiveProblemsA}{2}[\narrowtablewidth]{Description Problems  – Example 1}[lR[4]]%%[\activityColor]
Problem element & Description \\
