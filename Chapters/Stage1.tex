...
A key milestone is reaching the end of the stage, having produced a report which meets its writing outcomes, a key deliverable.  However, these are big jobs, so that you may like to break them down further.
...
\begin{guidance}You should make a note of key ideas, theories, approaches or principles from your course or its discipline, which are particularly relevant to the topics you have chosen. For thought degrees, identify specific study materials you may like to revise or apply in your project.
\end{guidance}\end{question}
%%Hack to correct tcbox behaviour
\color{black}
...
A deep-seated interest in a question\footnote{Great research often arises from the researcher's passion for the topic.} will help you keep interested. However, even a passionate interest can only take you so far: you should also avoid topics in which you have little existing knowledge, for instance, or that will require you to learn and master major new skills. This is particularly true of capstone Masters projects, whose timescale is relatively short\footnote{If you are doing one such project, you will be already very busy without having to learn completely new subject areas or master completely new skills.}.
...
Justification J & Inaccurate forecasting increases production cost and reduces profit margins and competitiveness \\
...
\begin{SimpleNColTable}{tab:descriptiveProblemsB}{2}[\narrowtablewidth]{Description Problems  – Example 2}[lR[4]]%[\activityColor]
Problem element & Description \\
...
In terms of complexity, the problem appears tightly focusses and doable as part of a Masters project; similarly, it is unlikely the problem will cease to be relevant in the time span of the research, so neither complexity nor volatility are of concern.
\end{running}
...
\item Objective 2 concerns the application of the techniques selected in context of the target UK university. Feasibility may relate to the kind of data required and their availability with the target university.
...
Note how those objectives are expressed using action verbs and build on each other -- if successfully completed, they will allow Anna to meet the overall research aim.
\end{example}
...
A third way to get to specific articles which you can't access from your library or via Google Scholar, is to contact the authors directly: academic authors are usually keen to have their work read and should be able to share pre-publication versions of their articles or even point you to other relevant publications they have written. Contact details of academic authors are usually found in the header of the articles they have published, or from their university's web pages. Alternatively, you may be able to contact them via professional networks, such as ResearchGate\footnote{ResearchGate is an online network specifically created to connect researchers around the world. It currently connect over 20 million researchers, allowing them to \enquote{connect, collaborate, and share their work.}} or LinkedIn. %\footnote{LinkedIn is the largest professional online network worldwide. It is not specific to academia, but many academics are part of it, so it is a useful place to make first contact.}.
...
Use Google Scholar to search the article's title and then download the paper.
...
Reviewing the literature is a process of knowledge discovery\footnote{To know where there are gaps in knowledge, you need to know what is already known -- hence knowledge discovery. A poor literature review may leave you unable to claim a contribution to knowledge.}, so it is both iterative\footnote{Iterative = it never finishes -- although it's better than it sounds: later iterations will typically make fewer changes than earlier ones} and incremental\footnote{Incremental = you'll add to it over time.}. Its core activities are summarised in~\Cref{tab:litrevactivities} alongside the key skills required. 

To conduct your literature review successfully, you will need to be able to select work which is relevant and should be included, assimilate and summarise relevant work of other researchers, synthesise and critically appraise ideas from different sources, establish links between studies and their findings, and draw on strengths and limitations of published research. In summary, in your literature review you will need to make use critically and creatively of the content of articles, books and other literature sources you have reviewed to demonstrate your knowledge of the subject, support your own arguments and justify your research. This chapter and the next will help you develop and apply these skills.
...
You shouldn't worry too much if you have come up with too many or too few terms in relation to each element: you will have an opportunity to review and refine your choices later --- this, too, is an iterative and incremental process.
\end{guidance}\end{question}
%%Hack to correct tcbox behaviour
\color{black}
...
\begin{question}[subtitle={Activity: Your first literature search}] Conduct searches in Google Scholar using the search terms you have brainstormed, combining them with Boolean operators above when appropriate.

For each search, record both the combination you use and how many articles Google Scholar returns as hits. Reflect on how using different terms and operators may change the number of hits and how that may inform ways to widen or narrow down your searches.
...
A summary-comparison matrix\footnote{This term is used in \textcite{sastry2013summary-comparison}, although another term used online is `literature matrix.'}is a useful tool to track the content of academic articles in a way which also makes it easier to compare the articles you have read. 
...
\begin{itemize}
	...
	\item Comments: these are your own notes on how the content of the article is relevant to, or could be used in your own project.
\end{itemize}
...
Comments & it seems a simple, yet effective, approach well worth applying when working on my literature\\
\end{SimpleNColTable}
...
%\end{itemize}
We conducted a literature search, out of which we identified a number of potentially relevant articles. We constructed a summary-comparison matrix, whose first couple of entries are illustrated in~\Cref{t:exampleSCMatrix}. 
\begin{guidance}
It is not necessary for you to understand all the details, but you may notice that our entries are quite detailed.	
\end{guidance}
\end{example}

\begin{question}[subtitle={Activity: Building your own summary-comparison matrix}] Create a summary-comparison matrix for your project, based on the articles you have identified as potentially relevant during processing.
\begin{guidance}
...
\begin{SimpleNColTable}{tab:conceptsOfInterest}{2}[\narrowtablewidth]{Concepts of interest}[R[5]R[4]]
 ...
 {~\textbullet~Whom does it affect?}&\SetCell[r=3]{m}Establishing the problem's significance, stakeholders, and \glspl{beneficiary} \\
...
\end{description}
%
Note that this is yet another iterative process, and you shouldn't expect to complete your concept map in one pass!
...
All research must be carried out ethically and legally\footnote{People who carry out unethical and illegal research cannot share their results within the academic community without being called out. They cannot, therefore, be called researchers.}, so that it is essential you consider your proposed research and research design from these standpoints. 

Your responsibilities as a researcher, many of which we will consider in this chapter, are to:
...
GDPR defines \glspl{personal-datum} as any information which may identify a living person, be that a name or a personal identification number, or a combination of physical characteristics, or cultural or social identities, and establishes rules for the use of such data.
...
\begin{question}[subtitle={Activity}] By asking your supervisor, searching on your university's intranet, or otherwise, find out which guidelines you should follow in relation to personal data in research and whether you are allowed to handle \glspl{sensitive-personal-datum} in your project.
\begin{solution}
...
Consider these GDPR four principles. Write down how you would ensure the principles apply when collecting personal data from your participants.
\begin{solution}
...
Your university is likely to have an IP policy which establishes, among others, which IP applies in the context of academic research, defining both ownership and related rights.
...
\begin{itemize}
	\item ChatGPT and Bard: these are conversational systems which allow users to conduct conversations in written natural language. They can be used to answer specific questions, for language translation and even creative writing
...
\item \gls{observation-bias}\footnote{Observation bias is also known as the Hawthorne effect. You can read about the original Hawthorne experiment here: \href{https://en.wikipedia.org/wiki/Hawthorne_effect}{https://en.wikipedia.org/wiki/Hawthorne\_effect}.} is the tendency of participants being observed during a study to change their behaviour, possibly to please the researcher or provide the answers they think the research is seeking. A way to counteract it is to complement your observation with other kinds of data collection and compare the outcomes -- this is called \gls{triangulation}
...
The management of risk is an important discipline in its own right\footnote{You'll be relieved to know that you won't not need all of the tools that that discipline offers for your project!}. In analysing risk for your project, you should focus on the following dimensions:
...
\begin{itemize}
	\item Writing down your reflection: to write down in a journal on a regular basis thoughts, emotions and insights from things you have done and experienced. You could use prompts, like `What did I learn today?, `What could I have done differently?, or `Which emotions did I experienced?' to guide your writing
...
In this activity you are asked to pause and think deeply about what you have leant and done as part of your studies, the wider context of your work and your own attitude to it. Specifically, you are asked to consider each of the following:
...
Stage 1 gives you a solid foundation for your whole research project. This is where you establish the scope of your research and its contribution to knowledge. Here're the takeaways from Stage 1.
%
\begin{itemize}
...
\item You work plan should guide you work, but not constrain it unnecessarily. It should be flexible enough to allow for the unknowns of doing research
...
\item Reviewing the literature is an iterative and incremental process of searching, gathering, processing, assimilating, analysing and synthesising content
\item Keshav's approach is an effective way to assimilate the content of an academic article
\item A bibliographical management tool (bmt) is a very useful support tool when doing a literature review. It helps you organise and keep track of articles you have reviewed alongside your notes and summaries
...
\item You can use a concept matrix and a concept map to identify themes emerging from your literature reviewed, and as the basis of your thematic summaries
...
\item Other regulatory frameworks establish rules and constraints you must abide to when conducting your research
\item Risk captures the likelihood of something going wrong combined with the impact that will have on your project, both on time, resources and outcome
\item All research projects are exposed to risk, which may arise from a lack of technical skills, time or resources, as well as from ethics or regulatory constraints. In addition, there may be risk arising from the specific nature of your research
