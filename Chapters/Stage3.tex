...
\begin{example}{\Glsf{validity} and reliability} 
...
\end{example}
 ...
 \begin{question}[subtitle={Activity: \Glsf{bias} and \glsf{validity}}]
...
\begin{question}[subtitle={Activity: Distinguishing different kinds of \glsf{triangulation}}]
...
%\begin{question}[subtitle={Activity: More on \glsf{triangulation}}]
...
%
%\subsubsection{\Glsf{novelty-weakness}}\label{sssect:NoveltyWeakness}
%
...
%
%\subsubsection{\Glsf{bias}}\label{sssect:bias}
%
...
\ReadingList{\glsf{survey-research}}{dillman2014internet,oates2008researching,johannesson2014research,kalaian2008encyclopedia}
...
%\RSActivity{\Glsf{survey-research}}{dillman2014internet,
...
\ReadingList{\glsf{design-science-research}}{oates2008researching,brocke2020introduction}
...
\ReadingList{\glsf{experimental-research}}{oates2008researching,johannesson2014research,field2002design}
...
\ReadingList{\glsf{case-study-research}}{yin2009case,oates2008researching}

%\RSActivity{\glsf{case-study-research}}{oates2008researching}
...
\ReadingList{\glsf{action-research}}{johannesson2014research,oates2008researching}
...
\ReadingList{\glsf{ethnography}}{johannesson2014research,oates2008researching}
...
\ReadingList{\glsplf{systematic-review}}{wright2007write,moher2009preferred,pollock2018systematic}
...
\ReadingList{\glsf{grounded-theory}}{drew2023grounded,smith1997understanding,corbin1990grounded,strauss1998basics,gibson2013rediscovering,charmaz2014constructing}
...
\ReadingList{\glsf{phenomenology}}{merleau-ponty1956what,anderson1991qualitative,smith2018phenomenology,shudak2018phenomenology,academic-educational-materials2019understanding,office2020phenomenological,groenewald2004phenomenological,hycner1985some}
...
\ReadingList{\glsf{simulation}}{dooley2017simulation}
...
\ReadingList{\glsf{mathematical-logical-proof}}{kleene1964introduction,lakatos2015proofs,antonini2011examples,johannesson2014research}
...
\ReadingList{\glsf{mixed-methods-research}}{johnson2007toward,denzin1978research,webb1999unobtrusive}
...
\begin{question}[subtitle={Activity: Choosing your \glsf{research-strategy}}]
...
\begin{question}[subtitle={Activity: Drafting your \glsf{research-methodology}}]
...
\begin{itemize}
	...
	\item research weaknesses include \glsf{validity}, reliability, novelty and \glsplf{bias-weakness}
...
%
%\subsection{\Glsf{design-science-research}}\label{ssect:DesignScienceResearch}
%
...
%\end{example}
%
%\begin{question}[subtitle={ACTIVITY: Establishing tasks and deliverables}] Consider your research objectives. For each, identify related tasks and \glsplf{deliverable}.\todo[inline]{I don't think I could do this at this point.}
%
...
%
%\begin{question}[subtitle={Activity: Assessing \glsf{validity} of \glsf{research-design}}] Conduct an initial assessment of your chosen \glsf{research-design} in relation to the three kind of \glsf{validity} discussed above. Write down a short summary of your thinking in support of each, and of possible threats to \glsf{validity} you envisage.
%
