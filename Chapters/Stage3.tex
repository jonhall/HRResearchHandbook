...
While your own research strategy will be specific and unique to your project in the way it informs the research you will conduct, standard research strategies have emerged over time, influenced by research mindsets and practice within specific disciplines. Each of them can be seen as a sort of `recipe' which summarises common ways to conduct academic research: by adopting or combining some of these strategies, you can come up with your own specific instance for your project. 
...
Case studies focus on the `how?' and `why?', so that the knowledge contribution is a detailed insightful account of the phenomenon in its context, including its relationships with other relevant phenomena, and any causal chain. 
