...
Should you find locating relevant dissertations within you institution difficult, then you should talk to your supervisor who will be able to point you to relevant examples, possibly from previous research students they have supervised.
...
You should apply some of the practices you have identified through the previous activity to help you develop a narrative that is appropriate for course and discipline.
...
\begin{guidance}
You should go back to the knowledge gap you identified in your literature review and captured in your research problem and explain how you have addressed it in your research. You should compare and contrast your work with that of related research reported in the literature, highlighted what makes your work novel.
\end{guidance}
\end{question}
%%Hack to correct tcbox behaviour
\color{black}
...
Recall that all research suffer from potential weaknesses\footnote{Recall \Cref{sect:DealingWithWeaknesses}.}, therefore you will need to argue why your research is trustworthy, has not been negatively impacted by your own bias or that of participants in your study, and the extent your findings generalise beyond your project. In doing so you, you should appeal to the ways you have dealt with research weaknesses in your methodological choices and procedures, while also acknowledging any remaining ones.   
...
\begin{guidance}
You should assess critically the extent the measures you have taken in your project to address these weaknesses have been successful. You should also highlight weaknesses you were unable to address.  
\end{guidance}
\end{question}
%%Hack to correct tcbox behaviour
\color{black}
...
Research is collaborative and incremental: your own research relies of research that came before, while other researchers may pick up from where you have left. In your conclusions, you should highlight possible future research which may follow from your work.
...
\begin{guidance}
Here you may discuss aspects of your research problem you didn't have the time to explore during your project, or other emerging related sub-problems which were not within the scope of your research. For each, you should indicate how future research could build on your work. 
...
Your research may relate to a practical problem in your profession, in which case in your evaluation you should also consider the  ways  in which your research may be relevant to professional practice, including how it may lead to change or improvement.

\begin{question}[subtitle={Activity: How your research may influence professional practice}]
Identify and justify ways in which your research may influence professional practice.
\begin{guidance}
You can skip this activity if your research has no professional relevance beyond academia. You should clarify ways outcomes from your project may apply or be adopted within a professional context, the potential benefits, as well enablers and barriers.
\end{guidance}
\end{question}
%%Hack to correct tcbox behaviour
\color{black}
...
\begin{guidance}
This is a very personal account which may or may not required by your course. We would recommend you do this activity regardless, to continue your process of personal growth through reflexivity.
\end{guidance}
\end{question}
%%Hack to correct tcbox behaviour
\color{black}
...
The end of your project is fast approaching: you can see the finishing line! What is left is to complete and submit your dissertation. 

Your dissertation should extend your Stage 4 report by covering the work you have carried out in this stage. The structure and content we recommend are indicated in \Cref{tab:dissertation}. 

You will already have a great proportion of your dissertation written as a result of diligently writing your reports in the previous stages. At this point you will need to fill in any remaining gap, starting from writing your dissertation abstract.
...
\section{Drafting an abstract for your research}\label{sect:abstractdraft}
...
\begin{guidance}
You should check whether your course requires a particular structure for your dissertation abstract: while most abstracts are written as a continuous narrative, abstracts which are structured around  each of the points above are more becoming common.
...
By now, you should have something to say in each of the chapters and sections suggested in \Cref{tab:dissertation}, with Chapters 1 to 3 being the most complete, and Chapter 4 requiring some editing, perhaps to account for changes in methodology while completing your data gathering and analysis. 

Chapters 5 and 6 are likely to require most of your effort at this point: while you will have much of the content you need as a result of the activities you have carried out in this stage, you will still need to bring all together into a coherent whole. Depending on your chosen methodology, material for certain sections may extend to many pages: for an experiment, it may be that there is an extensive sections on reflexivity, triangulation, and validation. These sections may be much shorter if they appear at all, in the mathematical thinking research strategy.
...
There is also an expectation that your dissertation conforms to some standard presentation conventions, which we have summarised in Cref{tab:presentationConventions}.

\begin{SimpleNColTable}{tab:presentationConventions}{2}{Presentation conventions}
...
\section{Final check before submission}\label{sect:finalcheck}
