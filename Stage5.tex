...
You will already have a great proportion of your dissertation written as a result of diligently writing your reports in the previous stages. Therefore, your dissertation should extend your Stage 4 report by covering the work you have carried out in this stage and addressing any remaining gap. The structure and content we recommend are indicated in \Cref{tab:dissertation}, which should not come as a surprise to you as it follows the structure we have used throughout this book.

While this structure is fairly typical of most research dissertations, you should check whether your course of study requires something different or even provide a dissertation template that you should use instead.


\begin{question}[subtitle={Activity: Your dissertation template}] 
Check your course of study regulations in relation to the structure of your dissertation, and compare with the structure suggested in \Cref{tab:dissertation}. Make a note of significant differences, and particularly of additional content you will need to inlcude.
\begin{guidance}
You should make use of your mapping between the two structures throughout this chapter to ensure you include all required elements in your dissertation before submission. 
\end{guidance}\end{question}
%%Hack to correct tcbox behaviour
\color{black}
...
It is particularly important that you are aware of extra criteria which are not captured in the  elements above. 
\end{guidance}\end{question}
%%Hack to correct tcbox behaviour
\color{black}
...
A research dissertation usually includes an abstract at the beginning. An {abstract} is a common way to summarise academic research, and an integral part of all published academic articles -- you will have encountered many abstracts while reviewing the literature. 
...
\begin{question}[subtitle={Activity: Putting your whole dissertation together}] Using your word processor of choice, and starting from your previous report, complete your dissertation by applying the structure and guidance in \Cref{tab:dissertation}, and making good use of your notes and summaries from all related activities you have carried out.

\begin{guidance} 
If your course requires a different structure or template you should use that instead. Equally, if the assessment approach of your course requires extra elements to be added to your dissertation, then this is the time to develop them and include in your full dissertation draft.
\end{guidance}\end{question}
%%Hack to correct tcbox behaviour
\color{black}
...
Often, there is also an expectation that the content of your dissertation is balanced across its  chapters\footnote{Although it is normal for some chapters to be more substantial than others.} and your course of study may provide specific recommendations on the expected size of each chapter. As an example, \Cref{tab:contentBreakdown} summarises what is expected in our university for Masters level research dissertations in STEM\footnote{STEM stands for Science, Technology, Engineering and Mathematics} taught programmes, where dissertations are expected to be between 10,000 and 15,000 words in length. Of course, these are only guidelines and should not be applied too rigidly: students can used them as a baseline, then adapt them to the needs of their project.
