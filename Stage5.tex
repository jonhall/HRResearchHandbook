...
\begin{table}[htbp]
\caption{Research activities addressed in Stage 5 (30\% of project length)\label{tab:stage5}}
\small
...
\midrule
 ...
 \textbf{Identifying the research problem} & Final research problem statement &  & 1\% & \\
 \textbf{Reviewing the literature} & Full literature review &  & 1\% &  \\
 \textbf{Setting your aim and objectives} & Finalised aim and objectives, appropriately broken down into tasks &  & 2\% & \\
 \textbf{Developing the research design} & Complete account of your research design & & 2\% & \\
\textbf{Gathering and analysing evidence} & Data appropriately presented and analysed, with extracts from raw data in dissertation appendix, if needed; remaining raw data appropriately stored & be able to organise and store your raw data; be able to apply appropriate data analysis methods; be able to present your data and evidence in a concise and effective way & 40\% & Appropriateness of data analysis and presentation\\
\textbf{Interpreting and evaluating findings} & Critical summary and evaluation of findings & be able to derive findings from your data analysis and critically assess them in relation to research aim and objectives & 20\% & Critical and logical thinking\\
 \textbf{Reflecting and reporting} & Full dissertation, including an assessment of the whole project & be able to assess entire research; be able to complete your dissertation to the expected presentation standards & 35\% & Depth of critical thinking, quality of academic writing, and conformance to standards \\
 \textbf{Planning work and managing risk} & Review of work from previous stage and project risk, with adjustment to work plan for Stage 5 & be able to assess risk and revise a work plan & 1\% & Any major adjustment required to complete the project \\
\bottomrule
\end{tabulary}
\end{table}
...
\begin{solution}
In this stage, gathering and analysing evidence and interpreting your findings will constitute your major effort (around 60\% of your study time), although considerable effort (35\%) will also be needed in assessing your research overall and completing your dissertation. You shouldn't underestimate the time needed to complete and polish the dissertation so that is ready for submission, which is why the framework assume a significant effort in this stage.\end{solution}\end{question}
%%Hack to correct tcbox behaviour
\color{black}


\section{Completing your research}
Building on Stage 4, in this stage you will complete your work on gathering and analysing data, on their interpretation in the context of a contribution tom knowledge. This will give you a substantial start of the presentation of your findings in your dissertation.

\begin{question}[subtitle={Activity: Completing your data gathering, analysis, and interpretation}] Complete your research on gathering and analysing data and evidence, and the interpretation of your findings in terms of your aim and objectives. Expand on your analysis and summaries from your Stage 4 report.
...
It's getting exciting – you now have all the data, evidence, and arguments in a form you need to complete your dissertation. You may have upwards of one hundred pages of carefully written prose that looks very good on screen. It's not time to finalise your dissertation for submission.

Your dissertation should extend your Stage 4 report by covering the work you have carried on in this stage. Its recommended structure and content are indicated in Table~\ref{tab:dissertation}: note that a dissertation is usually organised in chapters, rather than sections like your previous reports.
...
\subsection{Final check and submission}
...
\section{How your dissertation will be assessed}
...
\item \textbf{Data generation, analysis, interpretation, and conclusion}: this refers to a competent execution of your research design, an adequate amount of evidence gathered and analysed, an appropriate interpretation of your findings, and a critical evaluation of your research overall
