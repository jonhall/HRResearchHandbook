...
%\chapter{Stage 5: Completing your dissertation}\label{ch:Stage5}
...
With reference to our 5-stage framework, the activities which are in focus in Stage 5 are summarised in~\Cref{tab:stage5}, which also provides some guidance for your interaction with your supervisor during this stage.

\subsection{Your Research Activities for this stage}

\todo{More here}

\begin{SimpleThreeColTable}[\RActivitiesTableCaption{5}\label{stage5ResearchActivities}][X[1]X[2]X[2]]
...
Gathering and analysing evidence&Complete data/evidence generation and analysis&Overall quality and quantity of data/evidence and their analysis\\
Interpreting and evaluating findings&Critically assess all findings and the overall research conducted&Overall critical thinking in assessing findings\\
Reporting&Write up dissertation&Overall quality of dissertation\\
Reflecting&At stage end, think critically about experiential learning in relation to the research process and its activities&Overall critical thinking in assessing experiential learning\\
Planning work&At stage start, plan Stage 5 work in detail, including any revision or additional work needed from the previous stage.&Any major adjustment required\\
Managing risk&
...
%\input{Tables/StageBegin/Stage5}
\input{WritingOutcomes/Stage5}

\begin{question}[subtitle={Activity: Understanding the effort needed in this stage}] Consider~\Cref{tab:stage5} carefully, paying particular attention to the entries in the `Effort' column. Make a note of the activities which are most prominent in this stage and what their deliverables and learning outcomes are.
...
\section{Interpreting and evaluating data}\label{sect:intevaldata}
...
\section{Assessing your research}\label{sect:assessment}
...
\begin{SimpleTwoColTable}[Dissertation structure and guidance\label{tab:dissertation}]
...
\begin{SimpleFiveColTable}[Breakdown of dissertation content\label{tab:contentBreakdown}]
...
\begin{SimpleTwoColTable}[Presentation conventions\label{tab:presentationConventions}]
...
Title page & Include a title page containing your research title. Usually the following statement is also required: ``A dissertation submitted in partial fulfilment of the requirements for the degree of $<$name of degree$>$'', where you should replace $<$name of degree$>$ with your own degree title \\
...
\begin{SimpleTwoColTable}[Typical grade benchmarks for Masters dissertations, based on UK quality standards\label{tab:gradeBenchmarks}]
...
\chapter{Managing risk in Stage 5}\label{ch:ManagingRiskIn}

Trick chapter – there is no risk arising from this stage!
