...
With reference to our 5-stage framework, the activities which are in focus in Stage 5 are summarised in~\Cref{stage5ResearchActivities}, which also provides some guidance for your interaction with your supervisor during this stage.

\subsection{Your Research Activities for this stage}

\todo{More here}

\begin{SimpleNColTable}{stage5ResearchActivities}{3}{\RActivitiesTableCaption{5}}[X[1]X[2]X[2]]
...
\begin{guidance}Ensure you continue to manage your raw data carefully, and that your report presents all your data/data, findings and their interpretation in a clear and rigorous manner.
...
\chapter{Managing risk in Stage 5}\label{ch:ManagingRiskInStage5}

Trick chapter – there are no risks arising from this stage!
