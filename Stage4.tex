...
Having said that, mathematical thinking has less of a basis in real-world problem solving, although mathematical techniques can apply to real-world problems, the difficulty being that closed form solutions, as mathematics tends to create\footnote{A \emph{closed form} solution is something like a set of differential equations that completely describe a – typically idealised – problem.}. Mathematics has limits of applicability, some of which are extremely subtle, even in relatively simple situations: complete closed form solutions do not exist for problems as simple as finding the roots to polynomial equations of order 5\footnoet{So called \emph{quintic equations}.} or above; the general three body problem, for instance, being resistant to differential equation analysis; and others. 
...
Differential equations; Matrices; complex and other numbers; sets; logic; \todo{More here}
