...
*** LR -- decide what is relevant to include, starting with frequency, contingency (aka cross tabulation/two-ways) and pivot tables

In your research you may collect large amounts of raw data, possibly stored in a spreadsheet or database, so the issue arises as to how these can be reported in your dissertation and properly analysed.

To this end, tables are versatile tools which can help you summarise and analyse all sort of data, hence they are used extensively in research and often found in dissertations. We are looking at some common types in this section.

\paragraph{Pivot tables}
One way to summarise data is the use a \textit{pivot table} whose entries are aggregations of individual values out of larger tables, spreadsheets or databases.

***to do example and activity (maybe how to do a pivot table in Excel)
