...
You've now reached Stage 4, which means the end of your project is in sight. In this stage you will be in the midst of your data gathering and analysis, which is possibly the most exciting, yet demanding, part of your research: this is where you get an opportunity to make your original contribution to knowledge.

This stage assumes that you you have worked out most of your research design details and are now in position to make good progress with you data collection and analysis\footnote{If that's not the case, then, you should go back to Stage 3. You should also discuss your progress with your supervisor, revisiting your project risk around access to the required data and evidence.}.
...
\midrule
 ...
 \textbf{Developing the research design} & Research design description, refined as needed &  be able to describe data collection and analysis procedures in detail  & 2\% & Suitability of methods and procedures \\
...
\begin{solution}
Gathering and analysing evidence will constitute by far your major effort in this stage (50\% of study time): in particular, the framework assumes that you will have worked out the details of your research design in Stage 3, so you can focus on applying your data collection and analysis methods. You will also start to intepret you findings, an activity your will complete in Stage 5. 
...
\section{Gathering and organising your raw data}
Your \textit{raw data} represent any data and evidence you gather as part of your research. Key decisions in data gathering include how to choose your sample, should you need to, design a questionnaire, and how to store and organise your raw data to support your analysis. In this section, we outline some key aspects of collecting and organising raw data: this outline, however, is only an introduction touching on ew 

\subsection{Sampling}\label{sect:sampling}
Sampling is the process of selecting a sample from the population of interest, and may apply both in quantitative and qualitative research.

Broadly speaking, sampling is classified into random\footnote{Also known as \textit{probability} sampling.} and non random. In random sampling an algorithm is established to extract the sample from the population, while in non-random sampling, the choice is based on the judgement and discretion of the researcher. The former is used when the ability to generalise to the population is paramount, while the latter when the depth and richness of the sample is more important. As a result, the former is used more in quantitative research, and the latter in qualitative research. Also, in quantitative research the tendency is choose the sample upfront, before any analysis commences, while in qualitative research, the process is iterative, with more and more sample data collected and analysed until no more collection is possible or \textit{saturation} is reached, that is collecting more data would not bring more relevant information.
...
\begin{itemize}
	...
	\item cluster sampling, where the population is divide up in naturally occurring separate clusters, and the sample is obtained by randomly selecting some clusters and then randomly selecting members of those clusters. 
\end{itemize}

Non random sampling includes:
\begin{itemize}
	\item subjective\footnote{aka purpose -- check terminology in Rosen's book!} sampling, where the researcher chooses based on the researcher's own judgement and research aim. Used for small populations or especially rare population; target individuals with particular knowledge or expertise; prone to bias and unlikely to lead to generalisable results. Better suite for narrow and deep
	\item convenient sampling, where participants are selected based on their availability or accessibility. This is quick and easy, but unlikely to produce a representative sample, so it can be prone to bias
	\item snowball sampling, which relies on referral from previous participants to recruit new ones. This is an effective approach when a population is difficult to access or when the topic is sensitive or tabu. This too is unlikely to generate a representative sample, and is highly prone to bias.
\end{itemize}
...
Assuming your study requires you to perform some sampling, write down the approach you are going to take, with its justification in terms of what is needed to address your aim and objectives and any trade-offs due to the practicality of accessing the sample. Record any possible weakness or limitation in your approach.
\begin{guidance}
You can skip this activity if sampling is not relevant to your project.
\end{guidance}
\end{question}

\subsection{Questionnaire design}

Questionnaires are versatile tools designed to gather feedback from multiple participants on specific topics by asking a series of questions. Your aim is to characterise your population of interest by collecting participants' data about their attitudes, preferences, opinions, behaviours, etc. You may use a questionnaire as the basis of a large survey, or to conduct some interviews or focus groups. Whatever their use, you need to put some thought in your questionnaire design.

There are plenty of resources in the literature and online to help you design your questionnaires. Here we briefly recall some of the key things you need to consider.

\paragraph{Essential questions} you should identify the smallest possible set of questions you absolutely need to ask to address your research aim and objectives. While using several questions will give you richer data sets, long questionnaires usually put people off, so that fewer people may be willing to participate. 

\paragraph{Profiling questions} these are questions to ensure your respondents match specific characteristics you are interested in your study, say you are studying the usability of a new product, then you will need to know the extent your respondents have engaged with that product. This is particularly the case if you are running a large survey and don't know who's going to respond.  

\paragraph{Demographic questions} these are often used so that you can then compare answers across different sub-groups, say gender, age or ethnicity.


\paragraph{Use of language} your questions should be clear and plain, and you should avoid jargon and idioms, to ensure your participants understand what you are asking, particularly if not native speakers. Your questions should also be objectives, that is you should avoid any judgemental term or tone, which may lead participants to answer in a particular way, or make assumptions about your respondents' habits or behaviours, for instance asking participants what they eat for breakfast, assuming they all have breakfast.


\paragraph{Double-barreled questions} Also called compound, these are questions that ask more than one thing, while only allowing one answer. These should be avoided as it would be difficult, if not impossible, to establish in your analysis which part of the question each participant has answered. Instead, you should split the question into separate questions each addressing a specific thing.

\paragraph{Response options} questions are broadly divided into closed and open-ended. The former restrict the possible responses to a set of given possibilities, while the latter allow respondents to use their own words freely to answer the question. If you use closed questions you need to ensure they are exhaustive, in that they cover all possible options, and exclusive, in the sense they don't overlap. Open questions can lead to richer answer, but you must ensure they are sufficiently constrained so that the answers don't end up being too vague or off topic. 

\paragraph{Scales} if your questions require participants to estimate or measure something, you need to worry about both validity and reliability when setting up scales for possible answers. Validity means that the chosen scale will allow participants to measure something accurately; while reliability means that, under the same conditions, participants will be able to measure something consistently.

\paragraph{Question grouping, ordering and flow} related questions, say all questions on demographics characteristics, should be grouped together. The questions order also matters: as a rule of thumb, simpler questions should precede more complex ones. Similar, the flow between groups of questions should be logical.

\paragraph{Using bespoke tools} While you can design your questionnaire from scratch using your word processor, there are plenty of specialised digital tools, many of which are free, to help you design your questionnaires. They usually come with: templates and pre-defined question types that you can customise for your study; statistical analysis and data visualisation features that you can apply to the data you have collected; export functions that also allow you to export the data to a spreadsheet for further analysis. Overall, if you need to develop questionnaires for your research, they can really help you speed up the process, so that they are well worth considering. 

\paragraph{Testing your questionnaire} Once you have a first draft of your questionnaire, you should test it and refine it before you deploy it in your data collection. This will help you identify issues with any of the points we have just discussed, so that you don't waste time and resources by employing a poorly design survey in your study.

 Testing can be done by simply asking a friend, family member or colleague to go through it and provide some feedback, or ask an expert to review it, including, of course, your supervisor. In addition, you could pilot it on a small number of participants first, then revise it as necessary before using more widely. In all cases, you are looking for evidence where confusion (which may point to lack of clarity), or hesitation (which may point to poor response options or inappropriate scales) or disengagement (which may point to too many questions) may have occurred. 

\begin{question}[subtitle={Activity: Designing your questionnaire}]
Assuming your study requires you to use a questionnaire to collect data, consider each of the points above and jot down the possible approach you would take.
\begin{guidance}
You can skip this activity if questionnaires are not relevant to your project. Reflecting on each of the points will inform the design of your questionnaire and help you avoid common mistakes. 
\end{guidance}
\end{question}
...
Depending on your research strategy, you may gather data of many kinds. For instance, if you conduct experimental research, you will have data about your subjects, perhaps collected through interviews, and variables of interest, with their measurements. If you use interviews or focus groups, you may have audio or video recordings and their transcripts, or notes you have taken. For survey research, you will have a large number of responses to the set questions. If you use existing secondary evidence, for instance as part of case study research, then you will have all sort of documents, from reports to images, diagrams, etc.: from such documents, you will need to extract relevant raw data for your analysis.

Before proceeding with your data analysis, you must ensure your data are properly organised and stored, so that you don't loose track of important information, and you can easily locate and refer back to data during your analysis and when writing up your research -- often you are asked to include a sample of your raw data in an appendix of your dissertation.  With storage, you should ensure that your data is regularly backed up, not to risk loosing it, and, if you collect any personal information, your data, whether physical or digital, must be stored securely to comply with data protection\footnote{See Section~\ref{sect:personalData}.} regulations.

It is also important that you put your raw data in a form which is useable for analysis. Spreadsheets are particularly useful for this purpose, especially if your data is quantitative, so that this is a common way to organise and store raw data. In fact, most publicly available data sets used in research and beyond are stored as spreadsheet files: if you are going to use one such data set, then your raw data are already properly organised for you!  

Spreadsheet are naturally organised in rows and columns so that you can easily enter your raw data using columns for your variables and rows for your observations/measurements. As we will see later on, spreadsheets come a wide range of functionalities for data manipulation and for some level of data analysis. They are also easily extensible, so that you can grow your data sets incrementally.

\begin{question}[subtitle={Activity: Organising and storing your raw data}]
Consider the data and evidence you have collected or are planning to collect. Write down a list of actions you will need in relation to:
\begin{itemize}
	\item organising your data
	\item storing and backing up your data
	\item protecting personal data
\end{itemize}
\begin{guidance}
The kind of data you will collect will be unique to your project. ****are there tutorials on organising raw data??????
\end{guidance}
\end{question}
...
Your choice of data analysis methods will depend on the following factors: the kind of data and evidence you have, and what you are trying to achieve, that is your aim and objectives, and the research strategy(ies) and methods you have chosen to apply.
...
\begin{itemize}
	...
	\item \textbf{Significance} This is level of statistical significance for the test. It's known as the \textit{alpha} ($\alpha$) value from the Greek name of the mathematical variable used to express it. Most tests are run with $\alpha=0.05$, which gives a 5\% probability that we may infer that the null hypothesis is disproved while in actually it is correct\footnote{This is called a Type I error in Statistics.}.
	\item \textbf{Sample(s)} You need to have one or more (representative) samples of the population of interest  on which to perform the test. Multiple samples are used in some tests, typically to compare specific statistics in different groups within the population or changes within a group over time or after applying a treatment.
...
There are very many statistical tests to choose from, depending on the kind of data you have and their distribution, the purpose of your analysis and the number of samples involved. Statistical tests are applicable to both scalar and categorical data and can be used to compare values of specific statistics or to establish statistical associations between variables, where an \textit{association} between variables means that one variable can be used to provide some information about the other. The term \textit{correlation} is used to denote a particular type of association such that the two associated variables always change together, for instance they both increase or decrease at the same time, or when one increases the other always decreases. Statistical tests for association aim at estimating the strength (the extent changes in one lead to changes in the other) and direction (whether they change in the same or opposite way) of their possible correlation.

We will not cover all possible statistical tests in this introductory section, and only provide a summary of those most commonly applied. These are given in Tables~\ref{tab:testsForComparison} and \ref{tab:testsForAssociation}.

\begin{table}
	\caption{Common statistical tests for comparison. \textit{Parametric} tests apply to normally distributed data, while \textit{non parametric} tests to skewed distributions.}
...
\midrule
to compare the means of three or more independent samples & scalar dependent; nominal explanatory & to compare the mean scores (dependent) of students studying the same subject with three or more different teaching approaches (explanatory) & one-way ANOVA & Kruskal-Wallis test \\
\midrule
to compare the average difference between paired samples against a particular value & scalar dependent; time or condition as explanatory & to compare the blood pressure readings (dependent) of a group of people before and after exercising (explanatory) & paired t-test & Wilcoxon signed
...
\begin{itemize}
	...
	\item \textit{Scenario 4} to investigate whether taste in chocolate types, say white vs milk or dark, is related to gender in particular country.
	\end{itemize}
\begin{guidance}
To simplify things, always assume a normal distribution.
\end{guidance}
\begin{solution}
...
As indicated in Section~\ref{sect:dataAnalysisMethods}, common methods for qualitative data analysis include content, thematic, narrative or discourse analysis. While their goal may be difference, they all follow an initial step of coding, which we discuss in this section.

\subsubsection{Coding qualitative data}

A \textit{code} is essential a label which describes a piece of qualitative data, with \textit{coding} the process of creating and assigning codes to categorise those extracts. 

Coding is important and it helps you ensure that your analysis is systematic, and the codes will help you explore themes and patterns. However, codes are not themes: they are just labels used to group similar types of data, developed to support your follow-up analysis. 
...
Whichever the approach, you should follow a two-pass coding process. The first pass consists in going through the whole data set in order to establish which codes to use. In the second pass you apply the codes to the data bit by bit, say by line by line in a text, or frame by frame in a video, etc. In the second pass, the initial codes are reviewed or may become more detailed.

There are also various ways to choose the codes. For instance, \textit{in vivo} coding uses the exact language which occurs in the data: this is used, in particular, for participants' speech, especially when different languages are used. On the other hand, \textit{descriptive} coding\footnote{This is a very common approach, although there are others which you can research in the literature.} uses words which encapsulate a general idea, such as `sport' or `running': this is particularly useful for non textual data, like images or videos. 
...
The last step before detailed analysis is \textit{code categorisation}, which is the process of reviewing what you have coded and organise it into categories. For instance, from codes such as `football', `tennis' and `rugby' you may define a category 'sports'. In this way, you both organise your data and establish connections between codes and coded information. Both coding and categorisation are likely to be iterative until you reach saturation, that is no more is gained by further coding or categorisation. At this point, you can then proceed with your chosen analysis method, whether content, thematic, narrative, discourse analysis or other, in order to identify patterns and themes, and provide your own interpretation of the data.

Coding and categorising are time consuming tasks, particularly if you have a large amount of data to code. In most research, coding data by hand is impractical and you should at least make use of a word processor, perhaps using colours and comments to code segments of your text. Better still, you could  make use of a bespoke appropriate qualitative data analysis tool: many such tools are now available, some of which can also automate coding and categorisation to some extent.

\begin{question}[subtitle={Activity: Investigating tools for qualitative data coding}] 
Conduct a web search on tools which support qualitative data coding. List three or four which appear most commonly used. Indicate which coding features they offer and the extent they are freely available for students' research projects.
\begin{solution}
Qualitative analysis tools are growing and changing rapidly, particularly due to the integration and exploitation of AI capabilities. The most used commercial products, geared towards large research effort possibly across teams of researchers, include NVivo, ATLAS.it and MAXQDE. They all provide support for coding, with more or less extensive automation, alongside various other features such as data visualisation, statistical analysis, automatic transcripts generation from audio and video files, to name just a few. These commercial products are quite sophisticated with a steep learning curve and are usually quite expensive.

On the other hand, an increasing number of lighter, free products are also available. These include, for instance, Taguette, which supports manual coding and is both open source and free to use, or QDE Miner Lite, which is a free limited version of its full commercial release, and also supports manual coding. Such free products may be sufficient for Masters level research projects.

You may have, of course, found other similar tools.
\end{solution}
\end{question}
...
In writing up your data analysis, you will need to decide:

\begin{itemize}
	\item how to summarise data and evidence in the body of your report or dissertation. This will depend on the nature of your data and evidence, and you will need to ensure that your summaries are appropriate to convey the essence of the evidence you have generated and to support your analysis, so that you can build academic arguments which relate evidence to findings, and findings to aim and objectives. In the previous section, you have seen ways in which quantitative and qualitative data can be summarised using tables and visualisations.
...
Having gathered and analysed a certain amount of data and evidence, it is time to start interpreting your findings in relation to your aim and objectives, and generally evaluate them in terms of their contribution to knowledge and possible limitations. This is a process you will repeat and complete in Stage 5, the concluding stage of your project, ending with your dissertation submission.

By interpretation of your findings, we mean being able to answer the following questions:

\begin{itemize}
\item What does your data analysis show? What are your findings?
...
\begin{guidance}You can refresh your understanding of academic arguments by looking back at the related materials in Section~\ref{sect:??}.
