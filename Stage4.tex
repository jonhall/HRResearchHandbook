...
\begin{itemize}
	...
	\item \gls{decision}: this is based on the p-value in relation to the $\alpha$ value. If the p-value is less than the $\alpha$ value, then the null hypothesis is {rejected}, i.e. disproved, which means your \gls{alternative-hypothesis} that there is an effect in the population is supported by statistical evidence.
\end{itemize}
