...
\begin{table}
	\caption{Common statistical tests for comparison. \textit{Parametric} tests apply to normally distributed data (see Section\Cref{sect:descriptive}), while \textit{non parametric} tests to skewed distributions.}
