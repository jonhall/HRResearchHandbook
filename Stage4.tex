...
\subsection{Pivot tables}\label{ssect:pivotTables}
...
%%\end{figure}
%
\begin{SimpleNColTable}{tab:exampledata set}{7}{Example: the US housing market}[X[1]X[3]X[3]X[3]X[3]X[3]X[3]]
...
\begin{SimpleNColTable}{tab:pivot1}{5}{Pivot table of average property prices by neighbourhood and number of bedrooms}[X[2]X[3]X[3]X[3]X[3]]
...
\begin{SimpleNColTable}{tab:pivot2}{6}{Pivot table of property counts by neighbourhood and number of bedrooms/bathrooms}[X[3]X[3]X[3]X[3]X[3]X[3]]
...
\subsection{Frequency and contingency tables}\label{ssect:freqAndContTables}
...
\begin{SimpleNColTable}{tab:frequencyTableExample}{5}{Classifications frequencies}[X[1]X[3]X[3]X[3]X[3]]
...
\begin{SimpleNColTable}{tab:contingencyTableExample}{4}{Classifications frequencies by gender} [X[3]X[3]X[3]X[3]]
	 & Female & Male & Other\\
	Distinction & 7 & 5 & 0\\
	Merit & 12 & 13 & 1\\
	Pass & 21 & 19 & 2\\
...
Apply any statistical test required by your methodology to your data. For each test, you should ensure that your data meet the conditions for the application of that test.
\begin{guidance}
You should make use of a statistical package to perform your tests. 
\end{guidance}
\end{question}
...
A \gloss{code} is essential a label which describes an extract from qualitative data set, with \gloss{coding} the process of creating and assigning codes to categorise those extracts. 
...
While quantitative data can be summarised and presented using standard tables and charts, the same cannot be said of qualitative data, which, due to their heterogeneous nature, cannot be easily set out in a standard manner. 
...
\section{Summarising your data and writing up your analysis}\label{sect:WritingYourAnalysis}
...
\begin{itemize}
	\item how to summarise your data and evidence. This will depend on their nature, and you will need to ensure that your summaries are appropriate to convey the essence of the evidence you have generated. In the previous chapters, you have considered ways in which quantitative and qualitative data can be summarised using tables and visualisations. It may also be necessary for you to include sample raw data in an appendix
...
\item Tables are common ways to organise and present data, and a good starting point for data analysis 
...
\item Qualitative data are non-numerical and include text, images, audio, etc.
\item Qualitative analysis comes in many flavour, depending on your goal in extracting meaning from qualitative data
\item Coding is the first step in all qualitative analysis. It is the process of assigning labels to extracts from qualitative data to allow a systematic follow-up analysis
\item  Qualitative data are heterogeneous in nature, and you many need bespoke approaches to organise and present them
\item In writing up your data analysis you must decide how to summarise and present your data, how to report your findings and how to structure your arguments and narrative 
\end{itemize}
