...
Your \textit{raw data} represent any data and evidence you generate as part of your research. 
...
%
\begin{itemize}
\item design tips and techniques
\item a workflow to get your data generation going
...
Your characteristics\footnote{Domain knowledge, needs for deep insight, etc.} will determine whether you choose structure, semi-structured, or the unstructured form. 
...
\subsection{Journalling}\label{sect:DG:journalling}\todo{This section adapted from \cite{hayman2012journaling}.}

\ResGenTechnique{Journalling}

Journalling asks research participants to record and reflect on research-focussed experiences as \textcquote{hayman2012journaling}{a way of thinking, understanding, and learning.} Journalling can be used in two ways:
%
\begin{itemize}
\item as a learning strategy for research participants, as so is often located in ethnographic research, or in data generation for grounded theory. The researcher is interested in the ability of journalling to expose elements and processes involved in deep learning, problem solving, critical thinking development, and reasoning.
...
A researcher that wishes to journal with research participants should ...

There are three identified challenges for journalling \cite{hayman2012journaling}:
%
\begin{enumerate}%[start=0,label={(\bfseries R\arabic*):}]
\item poor participation:
\item feeling exposed: 
\item staying on track: 
\end{enumerate}
%
