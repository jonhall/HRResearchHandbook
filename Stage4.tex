...
All research needs data and in this chapter we step through the most used data generation methods. Most of them concern {empirical data}, that is data that is gathered through our five senses or from experience, yours or that of your study participants. 
...
You concluded Stage 4 with an initial draft of your methodology which included both your chosen research strategy and possible research methods within. Now it's the time to consider those methods in detail to ensure they are the right ones for your project, and to plan how you will apply them. 

The next activity will help you do that for your chosen data generation methods.
...
%\newcommand{\tick}{$\Box$}
\begin{SimpleNColTable}{tab:generationMethodsChoice}{2}{Data generation methods in this chapter}[X[1]X[1]]
	Method & Section\\
...
At the end of this activity you should have some good summaries for each of the data generation method you intend to apply in your project. You should share them with your supervisor and discuss ways you may improve them further.
...
Wolcott \cite{wolcott2005art} offers this salutary advice about fieldwork: 
%
...
This is a copy of a passage from \textcite{fynes1873the-miners}:
%
...
If your chosen research methodology included a choice of modelling methods, now it's the time to consider them in detail through the next activity. If not, you can skip this chapter and move on to the analysis methods in \Cref{ch:AnalysisMethods}.
...
At the end of this activity you should have some good summaries for each of the modelling method you intend to apply in your project. You should share them with your supervisor and discuss ways you may improve them further.
