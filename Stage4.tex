...
\Gls{frequency table}s are used to summarise the frequency (or count) of values taken by a categorical variables in a data set, while \gls{contingency table}s\footnote{Also known as \gls{cross-tabulation} tables.} extend frequency tables in order to tabulate the value frequencies of two categorical variables\todo{Table below breaks badly}. 
